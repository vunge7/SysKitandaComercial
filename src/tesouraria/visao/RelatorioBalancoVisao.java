 ...
 * @author Toshiba
 */
public class RelatorioBalancoVisao extends javax.swing.JFrame {

    private EntityManagerFactory emf = JPAEntityMannagerFactoryUtil.em;
//    private BancoDao bancoDao = new BancoDao(emf);
    private BalancoDao balancoDao = new BalancoDao(emf);
  
    
    
    public RelatorioBalancoVisao() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MAPA DO BALANÇO");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data", "Valor Banco", "Valor Caixa", "Valor Stock", "Balanço Total"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioBalancoVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void procedimento_mapa_balanco()
    {
        List<TbBalanco> lista;
        DefaultTableModel modelo = (DefaultTableModel)  jTable1.getModel();
        modelo.setRowCount(0);
        double total = 0;
        lista = balancoDao.getAllBalancoByData( dcDataInicio.getDate(), dcDataFim.getDate() );

        try {

            for (TbBalanco object : lista) {

                    modelo.addRow(  new Object[]
                    {
                                 MetodosUtil.getDataString( object.getDataBalanco() ) ,
                                object.getValorBancoOutros(),
                                object.getValorBancoCaixa(),
                                object.getValorBancoStock(),
                                ( object.getValorBancoOutros() + object.getValorBancoCaixa() + object.getValorBancoStock() )
    ...
    private void procedimento_imprimir()
    {
              ...
              new RelMapaBalanco( dcDataInicio.getDate() , dcDataFim.getDate() );
