 ...
 */
public class LevantamentoBancarioVisao extends javax.swing.JFrame
{
    ...
    private LevantamentoBancario levantamentoBancario;
...
//  private TransferenciaBancariaDao tranferenciaBancariaDao = new TransferenciaBancariaDao(emf);
    ...
    public LevantamentoBancarioVisao( Integer idUser )
    {
...
//       cmbBanco.setModel(   new DefaultComboBoxModel( (Vector) bancoDao.buscaTodosExceptoCaixaLocal1() ) );
    ...
    public boolean vazioValorLevantar()
    {
        return txtValorLevantamento.getText().equals( "" );
    }

    public boolean selecione()
    {

        if ( cmbBanco.getSelectedItem().equals( "--Seleccione--" ) )
        {
                ...
                if ( validar_borderaux() )
                {
                    ...
                    if ( validar_descricao() )
                    {
                        ...
                        if ( validar_valor_saldo() )
                        {
                            ...
                            try
                            {
                                levantamentoBancario = new LevantamentoBancario();
                                setDadosDepositoBancario();
                                levantamentoBancarioDao.create( levantamentoBancario );

//                                MetodosUtil.subtrair_saldo_banco( levantamentoBancario.getValor(), levantamentoBancario.getFkBanco().getIdBanco(), conexao );
                                //new MetodosUtil().adicionar_bancos(depositoBancario.getValor(), depositoBancario.getFkBanco().getIdBanco()  );
                                // limpar();
                                JOptionPane.showMessageDialog( null, "Valor levantado com sucesso!..." );
                                setDados();
                                actualizar();
                                limpar();
                            }
                            ...
                            {
                                JOptionPane.showMessageDialog( null, "Erro ao levantar valores ", "ERRO", JOptionPane.ERROR_MESSAGE );
                            }
    ...
    public void setDadosDepositoBancario()
    {
        ...
        levantamentoBancario = new LevantamentoBancario();
        levantamentoBancario.setData( new Date() );
        levantamentoBancario.setHora( new Date() );
        levantamentoBancario.setNborderaux( txtNumeroBorderaux.getText() );
        levantamentoBancario.setValor( Double.parseDouble( txtValorLevantamento.getText() ) );
        levantamentoBancario.setObs( txtareaOBS.getText() );
//        levantamentoBancario.setFkBanco( bancoDao.findTbBanco( getIdBancoDestino() ) );
        levantamentoBancario.setFkUsuario( usuarioDao.findTbUsuario( idUser ) );
...
//     }
    ...
    private void initComponents() {
        ...
        txtValorLevantamento = new javax.swing.JTextField();
        ...
        btn_levantar = new javax.swing.JButton();
        ...
        txtValorLevantamento.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtValorLevantamento)))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(14, 14, 14)
                                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(cmbBanco, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lbValorBanco, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lb10, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtValorLevantamento, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(36, 36, 36))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(7, 7, 7)
                .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        btn_levantar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/salvar_16x16.png"))); // NOI18N
        btn_levantar.setText("Levantar");
        btn_levantar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_levantarActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btn_levantar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel19.setText("LEVANTAMENTOS  BANCÁRIOS");
    ...
    public boolean validar_numero_menor()
    {
        ...
        if ( Double.parseDouble( txtValorLevantamento.getText().trim() ) == 0 )
        {
            JOptionPane.showMessageDialog( null, "Atenção\nInsira o valor a levantar na Conta!" );
            txtValorLevantamento.requestFocus();
            return false;
        }
        return true;
    ...
    {
        //        if(txtValorTranferencia.getText() != null){
        if ( txtareaOBS.getText().equals( "" ) )
        {
            JOptionPane.showMessageDialog( null, "Atenção\nDigite a descrição do levantamento do Valor!" );
...
//        TbBanco banco = bancoDao.findTbBanco( getIdBancoDestino() );

//           valor = banco.getSaldoBanco() - valor;
//        if ( ( Double.parseDouble( txtValorLevantamento.getText() ) ) > banco.getSaldoBanco() )
//        {
//            JOptionPane.showMessageDialog( null, "Atenção\nO valor a levantar não pode ser superior ao saldo do Banco!" );
//            txtValorLevantamento.requestFocus();
//            return false;
//        }
        return true;
...
//        lb10.setText( "Saldo Actual" );
    ...
    private void btn_levantarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_levantarActionPerformed
        // TODO add your handling code here:
        enviar();
    }//GEN-LAST:event_btn_levantarActionPerformed
...
//        alterar();
    ...
    public static void main( String args[] )
    {
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                new LevantamentoBancarioVisao( 1 ).setVisible( true );
            }
        } );
    }
    ...
    public static javax.swing.JButton btn_levantar;
    ...
    private javax.swing.JTextField txtValorLevantamento;
