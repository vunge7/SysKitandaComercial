 ...
 */
public class MapaCompletoVisao extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jLabel19.setText("MAPA DE SALÁRIOS");
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MapaCompletoVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
    ...
    private void procedimentoImprimir()
    {
        if ( camposValidos() )
        {
//            new MapaCompletoREPORT( dcDataComeco.getDate(), dcDataTermino.getDate() );
            new MapaCompletoREPORT( fechoPeriodo.getDataAbertura(), fechoPeriodo.getDataFecho() );
        }
    ...
    private String getDataInicio()
    {
        ...
        return fechoPeriodoDao.getAbertura(dcDataComeco.getDate() );
    }
    
    private String getDataFim()
    {

        return fechoPeriodoDao.getFecho(dcDataTermino.getDate() );
    }
