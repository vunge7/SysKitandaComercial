...
public class RenovacaoContratoVisao extends javax.swing.JFrame
{
    ...
    public RenovacaoContratoVisao( int idUser, int idEmpresa )
    {
        ...
        setComBoBox();
        lbEmpresa.setText(  empresaDao.findEmpresa(this.idEmpresa).getNome()      );
...
//            busca_pedido_ferias();
    ...
    private void initComponents() {
        ...
        setTitle("Renovação de Contrato");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(txtIniciaisProfessores, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel19.setText("RENOVAÇÃO DE CONTRATO");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel4Layout.createSequentialGroup()
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(cmbTipoContrato, 0, 169, Short.MAX_VALUE))
                            .addGap(18, 18, 18)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
                                .addComponent(dcDataInicioContrato, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGap(18, 18, 18)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jLabel14, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(dcDataFimContrato, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE))))
...
//        MetodosUtil.esvaziar_tabela( jTable2 );
...
//         */
//        double salario_base = salarioDao.getSalarioByIdFuncionario( idFuncionario );
//        txtTotalRemuneracaoDiaria.setText( CfMethods.formatarComoMoeda( salario_base ) );
        /**
         * ADICIONA OS PEDIDOS DE FÉRIAS DO FUNCIONÁRIO
         */
//        busca_subsidios_feria_natal( idFuncionario );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(RenovacaoContratoVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RenovacaoContratoVisao( 15, 1 ).setVisible( true );
            }
        } );
    }
...
//    }
    ...
    private void setComBoBox()
    {
        ...
        System.out.println("ID_EMPRESA"+idEmpresa);
...
//    {
//        
//        this.pedidoFeria.setDataInicio(dcDataInicioContrato.getDate() );
//        this.pedidoFeria.setDataFim(dcDataFimContrato.getDate() );
//        this.pedidoFeria.setDataRegistro( new Date() );
//        this.pedidoFeria.setDiasFerias(MetodosUtil.getDiasUteis(dcDataInicioContrato.getDate(), dcDataFimContrato.getDate() ) );
...
//    }
    ...
    private void preencher_dados_funcionario()
    {
         ...
         * DADOS PESSOAIS
         */
        lb_data_nacimento.setText( MetodosUtil.getDataString( funcionarioLocal.getDataNascimento() ) );
        lb_telefone.setText( funcionarioLocal.getTelefone() );
        lb_estado_civil.setText( funcionarioLocal.getFkEstadoCivil().getDesignacao() );
        //Morada é o mesmo que o endereço - infelizmente colocamos 'Morada', possivelmente nas outras versões futura do kitanda irá se rever esta questão 
        lb_endereco.setText( funcionarioLocal.getMorada() );

        /**
         * OUTROS DADOS
         */
        lb_departamento.setText( funcionarioLocal.getFkDepartamento().getDesignacao() );
        lb_grau_academico.setText( funcionarioLocal.getFkGrauAcademico().getDesignacao() );
        lb_especialidade.setText( funcionarioLocal.getFkEspecialidade().getDesignacao() );
        lb_modalidade.setText( funcionarioLocal.getFkModalidade().getDesignacao() );
//        lb_dias_uteis.setText( String.valueOf( funcionario.getFkModalidade().getDiasUteisTrabalho() ) );
         ...
         */
//        busca_pedido_ferias();
            cmbTipoContrato.setSelectedItem( funcionarioLocal.getTipoContrato());
            dcDataInicioContrato.setDate( funcionarioLocal.getDataInicioContrato());
            dcDataFimContrato.setDate( funcionarioLocal.getDataFimContrato());
            cmbDuracaoContrato.setSelectedItem( funcionarioLocal.getDuracaoContrato());
    }
...
//        esvaziar_tabela();
    ...
    private void verificarDataComeco()
    {
        ...
        if ( dcDataInicioContrato.getCalendar() != null )
        {
            Date data_1 = dcDataInicioContrato.getDate();
            ...
            {
                dcDataInicioContrato.setDate( null );
            ...
            {
                if ( dcDataFimContrato.getCalendar() != null )
                {
                    Date data_2 = dcDataFimContrato.getDate();
...
//                    }
    ...
    private void verificarDataTermino()
    {
        ...
        if ( dcDataFimContrato.getCalendar() != null )
        {
            Date data_1 = dcDataFimContrato.getDate();
            //a data de inserção do começo não pode ser menor do que a data actual do sistema.
            if ( MetodosUtil.menor_data_1_data_2_ignore_time( data_1, data_actual ) )
            {
                dcDataFimContrato.setDate( null );
            ...
            else
            {
                if ( dcDataInicioContrato.getCalendar() != null )
                {
                    Date data_2 = dcDataInicioContrato.getDate();
...
//    {
//        int diferencaDiasNormal = MetodosUtil.getTotalDias(dcDataInicioContrato.getDate(), dcDataFimContrato.getDate() );
//        
//        int diferencaDiasUteis = MetodosUtil.getDiasUteis(MetodosUtil.adicionarUmDiasNaData(dcDataInicioContrato.getDate(), 1 ), dcDataFimContrato.getDate() );
//        
...
//    }
    ...
    private void limiteDataTermino()
    {
        ...
        try
        {
            ...
            calendar_minimo.setTime(dcDataInicioContrato.getDate() );
            // calendar_minimo.add( Calendar.DATE, +1 );

            Calendar calendar_maximo = Calendar.getInstance();
            calendar_maximo.setTime(dcDataInicioContrato.getDate() );
...
//            calendar_maximo.add( Calendar.DATE, ( getDiasUteisPlanificados() + 8 + 1 ) );
            ...
            dcDataFimContrato.setMinSelectableDate( calendar_minimo.getTime() );
            dcDataFimContrato.setMaxSelectableDate( calendar_maximo.getTime() );
        }
        catch ( Exception e )
        {
        }
...
//        dcDataComeco.setMinSelectableDate( calendar_comeco.getTime() );
        calendar_comeco.setTime( ultimaData );
        calendar_comeco.add( Calendar.DATE, 1 );
        dcDataInicioContrato.setMinSelectableDate( calendar_comeco.getTime() );
        dcDataInicioContrato.setDate( calendar_comeco.getTime() );
        ...
        dcDataFimContrato.setDate( calendar_termino.getTime() );
