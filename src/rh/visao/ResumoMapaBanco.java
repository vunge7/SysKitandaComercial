...
//    private int  pk_armazem, pk_fornecedor;
    ...
    public ResumoMapaBanco(String periodo) 
    {
...
//        hashMap.put("DESIGNACAO_ARMAZEM", armazemDao.findTbArmazem(pk_armazem).getDesignacao() );  
        ...
        String relatorio = "relatorios/mapa_salario_banco.jasper";
        ...
        try {
            ...
            if (jasperPrint.getPages().size() >= 1) {
                ...
                JOptionPane.showMessageDialog(null, "Não existe registro para esta data!...", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
