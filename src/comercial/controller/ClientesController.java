...
public class ClientesController implements EntidadeFactory {
    ...
    public boolean salvar(Object object) {
        ...
        String INSERT = "INSERT INTO tb_cliente( nome , morada , telefone , nif , email, percentagem_desconto"
                + ")"
                + " VALUES("
                + "'" + clientes.getNome() + "' , "
                + "'" + clientes.getMorada() + "' , "
    ...
    public Vector<TbCliente> listarTodos2() {
        ...
        try {
            while (result.next()) {
                ...
                cliente.setPercentagemDesconto(result.getDouble("percentagem_desconto"));
