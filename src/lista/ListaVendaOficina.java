 ...
 */
public class ListaVendaOficina
{
    ...
    public ListaVendaOficina( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento )
    {
    ...
    public ListaVendaOficina( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento, String motivo_isencao )
    {
...
//                        EnvioEmailUtil.inicio("nota_levantamento_A4.pdf");
    ...
    public String getCaminho()
    {
        ...
        switch ( this.doc_breviacao )
        {
            ...
            case FR_A4:
                return CAMINHO_REPORT + "facturaA4_oficina.jasper";
            ...
            case FA:
                return CAMINHO_REPORT + "facturaA4_normal_oficina.jasper";
...
//                return CAMINHO_REPORT + "vistoria.jasper";
                return CAMINHO_REPORT + "factura_proforma_oficina.jasper";
...
//                    MetodosUtil.exportReportToPdf("nota_levantamento_A4.jasper", "nota_levantamento_A4.pdf", getParamentros(), getConexao());                    
    ...
    public static void main( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaVendaOficina( 28, abreviacao, false, false, "Original" );
    }
