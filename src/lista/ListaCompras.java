...
public class ListaCompras
{
    ...
    public ListaCompras( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento, String motivo_isencao )
    {
...
//                    JasperPrintManager.printReport(jasperPrint, true);       
    ...
    public String getCaminho()
    {
        ...
        {
            case SO:
                return CAMINHO_REPORT + "requisicao.jasper";
            case NE:
    ...
    {
        Abreviacao abreviacao = Abreviacao.SO;
        new ListaCompras( 11, abreviacao, false, false, "Original", "" );
    }
