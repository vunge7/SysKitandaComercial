 ...
 */
public final class RelatorioItensCanceladosReport
{
    ...
    public RelatorioItensCanceladosReport( Date data_incio, Date data_fim )
    {
    ...
    public void mostrar()
    {
        ...
        hashMap.put( "NOME_EMPRESA", this.dadosInstituicaoDao.findTbDadosInstituicao( 1).getNome() );
        hashMap.put( "ENDERECO_EMPRESA", this.dadosInstituicaoDao.findTbDadosInstituicao( 1).getEnderecos() );
        hashMap.put( "PARM_DATA_1", this.data_incio );
        hashMap.put( "PARM_DATA_2", this.data_fim );

        //obter o path do relatorio
        String relatorio = "relatorios/relatorio_item_cancelados_data.jasper";
