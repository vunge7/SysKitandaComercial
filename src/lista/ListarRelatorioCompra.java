 ...
 */
public class ListarRelatorioCompra extends javax.swing.JFrame
{
    ...
    public ListarRelatorioCompra( BDConexao conexao )
    {
    ...
    private void initComponents()
    {
        ...
        setTitle("...:::: DVML - RELATORIO DE COMPRAS POR INTERVALO DE DATAS::...");
        ...
        lbData2.setText("RELATÓRIO DE COMPRAS POR INTERVALO DE DATAS");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        {
            ResumoCompra resumoCompra = new ResumoCompra( dcDataInicio.getDate(), dcDataFim.getDate(), getTipoDocumento() );
        }
        else
        {
            System.out.println( "Fornecedor: " );
            ResumoCompra resumoCompra = new ResumoCompra( dcDataInicio.getDate(), dcDataFim.getDate(), getTipoDocumento(), getIdFornecedor() );
        }
    ...
    private void reimprimir_CO()
    {
        DefaultTableModel modelo = ( DefaultTableModel ) jTable1.getModel();
        int selectedRow = jTable1.getSelectedRow();
        String codRef = modelo.getValueAt( selectedRow, 0 ).toString();

        procedimento_reimprimir_CO( codRef );
    }

    private void procedimento_reimprimir_CO( String ref_doc )
    {

        HashMap hashMap = new HashMap();
//        TbVenda venda = vendaDao.findByCodFactReemprensao(ref_doc);
        Compras compras = comprasDao.findByCodFactReemprensaoCompras( ref_doc );

        if ( compras != null )
        {

            DVML.Abreviacao abreviacao = DVML.getAbreviacao( compras.getFkDocumento().getPkDocumento() );
            abreviacao = DVML.Abreviacao.CO;
            ...
            ListaCompra listaCompra = new ListaCompra( compras.getPkCompra() );
        }
        else
        {
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( ListarRelatorioCompra.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                ...
                {
                    Logger.getLogger( ListarRelatorioCompra.class.getName() ).log( Level.SEVERE, null, ex );
                }
            }
        } );
    }
    ...
    private void adicionar_tabela()
    {
        ...
        try
        {
            ...
            if ( rbGeral.isSelected() )
            {
                ...
                lista = comprasDao.getAllComprasByBetweenDataAndDocumento( MetodosUtil.getDataBanco( dcDataInicio.getDate() ), MetodosUtil.getDataBanco( dcDataFim.getDate() ), getTipoDocumento() );
            }
            else
            {
                lista = comprasDao.getAllComprasByBetweenDataAndDocumento( MetodosUtil.getDataBanco( dcDataInicio.getDate() ), MetodosUtil.getDataBanco( dcDataFim.getDate() ), getTipoDocumento(), getIdFornecedor() );
            }
...
//            Integer last_compras = comprasController.getLastCompras().getPkCompra();
//            int last_compra = comprasDao.getLastCompra();
