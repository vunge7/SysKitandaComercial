 ...
 */
public class ListarVendasByClientesVips extends javax.swing.JFrame
{
    ...
    public ListarVendasByClientesVips( int idUser, BDConexao conexao )
    {
...
//    
    ...
    private void initComponents()
    {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Item", "Cod.Prod.", "Qtd", "Preço Fábrica", "Total", "Bonus"
            }
        )
        {
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        {
            Logger.getLogger(ListarVendasByClientesVips.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//        }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(ListarVendasByClientesVips.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
