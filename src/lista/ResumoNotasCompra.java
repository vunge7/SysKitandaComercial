 ...
 */
public class ResumoNotasCompra
{
    ...
    public ResumoNotasCompra( Date data_incio, Date data_fim, int id_documento )
    {
        ...
        try
        {
            relatorio = CAMINHO_REPORT + "relatorio_nota_compra.jasper";
            mostrar();
        }
        catch ( Exception e )
        {
    ...
    public ResumoNotasCompra( Date data_incio, Date data_fim, int id_documento, int id_fornecedor )
    {
        ...
        try
        {
            relatorio = CAMINHO_REPORT + "relatorio_nota_compra_by_fornecedor.jasper";
            mostrar();
        }
        catch ( Exception e )
        {
