...
public  class RelGeralDepositos {

   
    private Date data_inicio,data_fim ;

    public RelGeralDepositos(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/PRINC_RELATORIO_DEPOSITOS.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralDepositos(new Date(), new Date());
