...
public class ResumoNotas
{
    ...
    public ResumoNotas( Date data_incio, Date data_fim, int id_armazem, List<TbVenda> list, int id_documento )
    {
...
//        if ( id_documento != DVML.DOC_FACTURA_FT )
//        {
            String relatorio = "relatorios/princ_relatorio_diario_notas.jasper";
//        }
//        else
//        {
...
//        else
//        {
//            relatorio = por_ordem ? "relatorios/princ_relatorio_diario_ordem.jasper" : "relatorios/princ_relatorio_diario_factura_ordem.jasper";
//        }
//        //obter o path do relatorio
//
//        
...
////            relatorio = !por_ordem ? "relatorios/princ_relatorio_diario_ordem.jasper" : "relatorios/princ_relatorio_diario_factura_ordem.jasper";
////        }
////        else if ( id_documento != DVML.DOC_FACTURA_RECIBO_FR )
////        {
////            relatorio = por_ordem ? "relatorios/princ_relatorio_diario_factura_ordem.jasper" : "relatorios/princ_relatorio_diario_ordem.jasper";
////        }
//        
//        
//        File file = new File( relatorio ).getAbsoluteFile();
