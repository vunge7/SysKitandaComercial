 ...
 */
public class ResumoFormaPagamento_A6
{
    ...
    public ResumoFormaPagamento_A6( Date data_incio, Date data_fim, int id_armazem )
    {
    ...
    public ResumoFormaPagamento_A6( Date data_incio, Date data_fim, int id_armazem, int id_forma_pagamento )
    {
    ...
    public void mostrar()
    {
        ...
        String relatorio = "relatorios/relatorio_por_forma_de_pagamentos_A6.jasper";
...
//        String relatorio = "relatorios/relatorio_por_forma_de_pagamento_forma.jasper";
        String relatorio = "relatorios/forma_A6.jasper";
