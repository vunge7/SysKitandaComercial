...
public class ImprimirPrecos
{
    ...
    public ImprimirPrecos( String cod_barra, double preco_retalho, double preco_grosso, double qtd, int cod_produto, String designacao, String dados_instituicao )
    {
    ...
    {
        new ImprimirPrecos( "6181100231199", 12, 12, 4, 1, "Produtos A", "" );
    }
