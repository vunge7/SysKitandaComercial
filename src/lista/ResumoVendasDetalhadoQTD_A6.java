 ...
 */
public  class ResumoVendasDetalhadoQTD_A6 {
    ...
    private int  pk_armazem, cod_produto;


    
    public ResumoVendasDetalhadoQTD_A6(Date data_incio,Date data_fim, int pk_armazem, int cod_produto) 
    {
     ...
     public void mostrar(){
       ...
       //PARM_LUCRO
        ...
        hashMap.put("PARM_ID_PRODUTO", this.cod_produto);      
        hashMap.put("DESIGNACAO_ARMAZEM", armazemDao.findTbArmazem(pk_armazem).getDesignacao() );  
        hashMap.put("DESIGNACAO_PRODUTO", produtoDao.findTbProduto(cod_produto).getDesignacao() );  
        ...
        String relatorio = "relatorios/relatorio_diario_produtos_detalhado_A6.jasper";
