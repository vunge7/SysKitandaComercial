...
public  class RelGeralConta {

   
    private Date data_inicio, data_fim;

    public RelGeralConta(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/Princ_Relatorio_Contas_Geral.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralConta(new Date(), new Date());
