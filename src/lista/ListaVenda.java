...
//    private DVML.Abreviacao doc_breviacao;
    ...
    public ListaVenda( int cod_venda, Abreviacao doc_abrevicao, int cod_mesa, int pk_lugar, boolean performance, boolean a5, String status_documento )
    {
...
//    public ListaVenda( int codigo, boolean performance, boolean a5, String status_documento )
    public ListaVenda( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean a5, String status_documento )
    {
        try
        {
            String impressora = "Adobe PDF";
...
//        return "relatorios/factura_A5_1_pedidos.jasper";
    ...
    public static void main( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaVenda( 1, abreviacao, 1, 1, false, true, "Original" );
