...
public  class RelGeralLevantamentos {

   
    private Date data_inicio,data_fim ;

    public RelGeralLevantamentos(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/PRINC_RELATORIO_LEVANTAMENTOS.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralLevantamentos(new Date(), new Date());
