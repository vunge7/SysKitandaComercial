 ...
 */
public class ListarVendasByUsuarios extends javax.swing.JFrame
{
    ...
    public ListarVendasByUsuarios( int idUser, BDConexao conexao )
    {
        ...
        this.idUser = idUser;
        usuario_selecionado();
        cmbUsuario.setModel( new DefaultComboBoxModel( ( Vector ) usuarioDao.getTodosUsuario() ) );
...
//        bt_pesquisa.setVisible( false );
    ...
    private void usuario_selecionado()
    {
        TbUsuario usuario = ( TbUsuario ) usuarioDao.findTbUsuario( this.idUser );

        if ( usuario.getIdTipoUsuario().getIdTipoUsuario() == DVML.COD_TIPO_USUARIO_SUB_ADMINISTRADOR )

        {
            cmbUsuario.setSelectedItem( usuario.getNome() );
    ...
    public double getTotalValor( int codUtilizdor )
    {
        ...
        String sql = "SELECT  SUM(total_venda) as soma FROM tb_venda WHERE codigo_usuario = " + codUtilizdor + "  AND performance = 'false'  AND status_eliminado = 'false'  AND credito = 'false'  AND dataVenda = '" + getDataSelecionadaString() + "'";
    ...
    public double getTotalValor( int codUtilizdor, int cod_armazem, int cod_documento )
    {

        String sql = "SELECT  SUM(total_venda) as soma FROM tb_venda WHERE DATE(dataVenda) BETWEEN '" + getDataSelecionadaString( dc_inicio ) + "' AND '" + getDataSelecionadaString( dc_fim ) + "' AND  codigo_usuario = " + codUtilizdor + "  AND performance = 'false'  AND fk_documento = " + cod_documento + " AND status_eliminado = 'false'  AND credito = 'false' AND idArmazemFK = " + cod_armazem;
        System.out.println( sql );
        ResultSet rs = conexao.executeQuery( sql );
...
//    
    public void mostrarUsuarios() throws SQLException
    {
        ...
        hashMap.put( "ID_USUARIO", this.getCodigoUsuario() );
        ...
        hashMap.put( "TOTAL_USUARIO", getTotalValor( getCodigoUsuario(), getCodigoArmazem(), getTipoDocumento() ) );
        hashMap.put( "LUCRO_USUARIO", itemVendaDao.lucro( dc_inicio.getDate(), dc_fim.getDate(), getCodigoArmazem(), getTipoDocumento(), getCodigoUsuario() ) );
        String relatorio = "";
        ...
        catch ( JRException jex )
        {
            ...
            JOptionPane.showMessageDialog( null, "Falha ao tentar mostrar o relatório de vendas do usuário!..." );
        }
        catch ( Exception ex )
        {
            ex.printStackTrace();
    ...
    public void mostrarUsuariosA6() throws SQLException
    {
        ...
        hashMap.put( "LUCRO_USUARIO", itemVendaDao.lucro( dc_inicio.getDate(), dc_fim.getDate(), getCodigoArmazem(), getTipoDocumento(), getCodigoUsuario() ) );
        String relatorio = "";
        relatorio = "relatorios/lista_venda_by_usuario_A6.jasper";
        File file = new File( relatorio ).getAbsoluteFile();
...
//    
    ...
    private void initComponents() {
        ...
        lbData2.setText("RELATÓRIO DE VENDAS POR USUÁRIO");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        {
            Logger.getLogger( ListarVendasByUsuarios.class.getName() ).log( Level.SEVERE, null, ex );
        }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( ListarVendasByUsuarios.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
...
//        {
//            
//            List<TbVenda> lista = vendaDao.getAllVendaByBetweenDataAndArmazem( dc_inicio.getDate(), dc_fim.getDate(), getCodigoArmazem(), getCodigoUsuario(), getTipoDocumento() );
//            
