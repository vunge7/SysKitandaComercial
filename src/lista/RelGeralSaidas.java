...
public  class RelGeralSaidas {

   
    private Date data_inicio,data_fim ;

    public RelGeralSaidas(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/PRINC_RELATORIO_SAIDAS.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralSaidas(new Date(), new Date());
