...
import dao.VendaDao;
import enties.util.DocumentoResumoUtil;
import java.io.File;
 ...
 */
public class RelatorioMensalTalho extends javax.swing.JFrame
{
    ...
    public RelatorioMensalTalho( BDConexao conexao )
    {
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(moutnChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(RelatorioMensalTalho.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RelatorioMensalTalho( BDConexao.getInstancia() ).setVisible( true );
            }
        } );
    }
