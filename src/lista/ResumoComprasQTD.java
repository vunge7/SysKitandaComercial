...
public  class ResumoComprasQTD {
    ...
    public ResumoComprasQTD(Date data_incio,Date data_fim, int pk_armazem) 
    {
...
//    public ResumoComprasQTD(Date data_incio,Date data_fim, int pk_armazem, int pk_fornecedor) 
//    {
//    
//        this.data_incio = data_incio;
//        this.data_fim = data_fim;
...
//    }
    ...
    public void mostrar(){
       ...
       //PARM_LUCRO
        ...
        String relatorio = "relatorios/relatorio_compra_diario_produtos.jasper";
