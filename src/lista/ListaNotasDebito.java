...
public class ListaNotasDebito
{
    ...
    public ListaNotasDebito ( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, HashMap hashMap, String motivo_isencao )
    {
...
//        }
    ...
    public static void main ( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaNotasDebito ( 13419, abreviacao, false, true, hashMap, "" );
