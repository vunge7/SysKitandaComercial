 ...
 */
public  class ResumoVendaFormaPagto {
    ...
    public ResumoVendaFormaPagto(Date data_incio,Date data_fim) 
    {
    ...
    public void mostrar(){
       ...
       //PARM_LUCRO
        ...
        hashMap.put("PARM_LUCRO", itemVendaDao.lucro(data_incio, data_fim));      
        hashMap.put("SUBREPORT_DIR", "relatorios/");
          
        //obter o path do relatorio
        String relatorio = "relatorios/princ_relatorio_diario_imposto.jasper";
