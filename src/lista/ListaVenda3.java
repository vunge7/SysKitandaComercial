...
public class ListaVenda3
{
    ...
    public ListaVenda3( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento )
    {
    ...
    public ListaVenda3( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento, String motivo_isencao )
    {
...
//                        EnvioEmailUtil.inicio("nota_levantamento_A4.pdf");
    ...
    public String getCaminho() 
    {
        ...
        switch ( this.doc_breviacao )
        {
            ...
            case FR_S_A6:
                return CAMINHO_REPORT + "facturaA6_mesas.jasper";
...
//                return CAMINHO_REPORT + "facturaA6.jasper";
            ...
            case NC:
                return CAMINHO_REPORT + "notaCreditoDebito5.jasper";
...
//                    MetodosUtil.exportReportToPdf("nota_levantamento_A4.jasper", "nota_levantamento_A4.pdf", getParamentros(), getConexao());                    
    ...
    public static void main( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaVenda3( 1, abreviacao, false, false, "Original" );
    }
