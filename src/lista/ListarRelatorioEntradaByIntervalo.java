 ...
 */
public class ListarRelatorioEntradaByIntervalo extends javax.swing.JFrame
{
    ...
    public ListarRelatorioEntradaByIntervalo( BDConexao conexao )
    {
...
//        cmbArmazem.setModel(new DefaultComboBoxModel(armazemDao.buscaTodos()));
    ...
    private void initComponents()
    {
        ...
        lbData2.setText("RELATÓRIO DE ENTRADAS DE PRODUTOS POR INTERVALO DE DATAS");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Entrada Nº", "Data", "Armazem", "Usuário"
            }
        )
        {
...
//        new ResumoSaidasByIntervalo(dcDataInicio.getDate(), dcDataFim.getDate(), getCodigoArmazem());
        new ResumoEntradasByIntervalo( dcDataInicio.getDate(), dcDataFim.getDate() );
    ...
    private void procedimento_reimprimir_FR( int codigo )
    {

        HashMap hashMap = new HashMap();
        TbEntrada entrada = entradaDao.findByCodFactReemprensao( codigo );
    ...
    public static void main( String args[] )
    {
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                try
                {
                    new ListarRelatorioEntradaByIntervalo( BDConexao.getInstancia() ).setVisible( true );
                }
                catch ( Exception ex )
                {
...
//            List<SaidasProdutos> lista = saidasProdutosDao.getAllSaidaByBetweenDataAndArmazem(dcDataInicio.getDate(), dcDataFim.getDate(), getCodigoArmazem() );
            List<TbEntrada> lista = entradaDao.getAllEntradaByBetweenData( dcDataInicio.getDate(), dcDataFim.getDate() );

            for ( TbEntrada object : lista )
            {
