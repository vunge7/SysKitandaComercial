 ...
 */
public  class ResumoVendasDetalhadoQTD {
    ...
    public ResumoVendasDetalhadoQTD(Date data_incio,Date data_fim, int pk_armazem, int cod_produto) 
    {
     ...
     private void mostrar(){
       ...
       //PARM_LUCRO
        ...
        String relatorio = "relatorios/relatorio_diario_produtos_detalhados.jasper";
