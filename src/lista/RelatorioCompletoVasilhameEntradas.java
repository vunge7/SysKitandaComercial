 ...
 */
public  class RelatorioCompletoVasilhameEntradas {

    private Date data_incio, data_fim;
    private int id_armazem = 0;

    public RelatorioCompletoVasilhameEntradas(int id_armazem, Date data_inicio, Date data_fim) {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/resumo_completo_entrada_vasilhame.jasper";
