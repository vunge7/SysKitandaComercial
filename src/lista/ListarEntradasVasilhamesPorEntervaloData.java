 ...
 */
public class ListarEntradasVasilhamesPorEntervaloData extends javax.swing.JFrame {
    ...
    public ListarEntradasVasilhamesPorEntervaloData() throws SQLException {
...
//    
    ...
    private void initComponents() {
        ...
        tabela_entrada.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod. Entrada", "Data", "Hora", "Armazém", "Usuario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        tabela_entrada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabela_entradaMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tabela_entrada);
        ...
        jLabel1.setText("REGISTRO DE ENTRADA DE VASILHAMES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( opcao == JOptionPane.YES_OPTION   )
        {
                new RelatorioDetalheVasilhameEntradas( getCodigoArmazem(),  dcDataInicio.getDate() , dcDataFim.getDate() );
        
        }else   new RelatorioCompletoVasilhameEntradas( getCodigoArmazem(),  dcDataInicio.getDate() , dcDataFim.getDate() );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        adicionar_tabela_entrada_vasilhame(  entradaVasilhameDao.getAllEntradaVasilhameByIdArmazem(id_armzem, dcDataInicio.getDate(), dcDataFim.getDate()
        )      );
    ...
    private void tabela_entradaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_entradaMouseClicked
        // TODO add your handling code here:
        
        
        if(evt.getClickCount() >= 1)
        {
            procedimento_detalhes_entrada();
        }
          
        
        
        
    }//GEN-LAST:event_tabela_entradaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarEntradasVasilhamesPorEntervaloData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ListarEntradasVasilhamesPorEntervaloData.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    public void adicionar_tabela_entrada_vasilhame(List<TbEntradaVasilhame> entrada_vasilhames) {
        ...
        try {
             ...
             for (int i = 0; i < entrada_vasilhames.size(); i++) {

                modelo.addRow(new Object[]{
                    entrada_vasilhames.get(i).getPkEntradaVasilhame(),
                    getData (     entrada_vasilhames.get(i).getDataEntrada() ),
                    getHora( entrada_vasilhames.get(i).getHoraEntrada() ),
                    entrada_vasilhames.get(i).getFkAmazem().getDesignacao(),
                    entrada_vasilhames.get(i).getFkUsuario().getNome()
    ...
    {
         adicionar_tabela_item_entrada_vasilhame(null);
    }
    
    
     public void adicionar_tabela_item_entrada_vasilhame(List<TbItemEntradaVasilhame> item_entrada_vasilhames) {
        ...
        try {
             ...
             for (int i = 0; i < item_entrada_vasilhames.size(); i++) {

                modelo.addRow(new Object[]{
                    item_entrada_vasilhames.get(i).getFkVasilhame().getPkVasilhame(),
                    item_entrada_vasilhames.get(i).getFkVasilhame().getDescricao(),
                    item_entrada_vasilhames.get(i).getFkVasilhame().getFkProduto().getDesignacao(),
                    item_entrada_vasilhames.get(i).getQtd()
...
//   
   ...
   private void procedimento_detalhes_entrada()
   {
       
           try {
                 
                 DefaultTableModel modelo = (DefaultTableModel) tabela_entrada.getModel();
                 int idEntradaVasilhame  =   Integer.parseInt(     String.valueOf(      modelo.getValueAt(   tabela_entrada.getSelectedRow()  , 0)  )  ); 
             
                 adicionar_tabela_item_entrada_vasilhame(    new ItemEntradaVasilhameDao(emf).getAllEntradaVasilhameByIdArmazem(idEntradaVasilhame) );
