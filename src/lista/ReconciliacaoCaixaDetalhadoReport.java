 ...
 */
public class ReconciliacaoCaixaDetalhadoReport
{
    ...
    public ReconciliacaoCaixaDetalhadoReport( int pk_caixa, BDConexao conexao )
    {
...
//                JasperPrintManager.printReport( jasperPrint, false );              
    ...
    public String getCaminho()
    {
        ...
        switch ( tipoFechoCaixa )
        {
            ...
            case "Detalhado":
                FILE = "reconciliacao_caixa_detalhado.jasper";
                break;
            default:
    ...
    {
        new ReconciliacaoCaixaDetalhadoReport( 4, BDConexao.getInstancia() );
    }
