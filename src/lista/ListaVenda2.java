...
public class ListaVenda2
{
    ...
    public ListaVenda2( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento )
    {
    ...
    public ListaVenda2( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, String status_documento, String motivo_isencao )
    {
...
//                    MetodosUtil.exportReportToPdf("nota_levantamento_A4.jasper", "nota_levantamento_A4.pdf", getParamentros(), getConexao());                    
    ...
    public static void main( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaVenda2( 1, abreviacao, false, false, "Original" );
    }
