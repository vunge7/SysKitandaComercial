 ...
 */
public class RelatorioVendasProdutos {
    ...
    private  List<RelatorioDiarioUtil> lista  = new ArrayList();   
    private double tota_venda = 0;
    private String periodo = "";
    
    public RelatorioVendasProdutos(List<RelatorioDiarioUtil> venda_suario_util, String periodo){
    ...
    {             
            return "relatorios/relatorio_diario_produto.jrxml";    
    }
    ...
    public static void main(String[] args) {
        ...
        //new RelatorioVendasProdutos(itemVendaDao.getRelatorioDiaio(new Date(), new Date()), "");
