...
public  class ResumoVendasQTD {
    ...
    public ResumoVendasQTD(Date data_incio,Date data_fim, int pk_armazem) 
    {
    ...
    public ResumoVendasQTD(Date data_incio,Date data_fim, int pk_armazem, int pk_fornecedor) 
    {
