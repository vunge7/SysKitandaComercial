 ...
 */
public final class RelatorioGorjetasReport
{
    ...
    public RelatorioGorjetasReport( Date data_incio, Date data_fim )
    {
    ...
    public void mostrar()
    {
        ...
        String relatorio = "relatorios/relatorio_gorjetas_intervalo_data.jasper";
