 ...
 */
public  class RelatorioCompletoVasilhameSaida {

    private Date data_incio, data_fim;
    private int id_armazem = 0;

    public RelatorioCompletoVasilhameSaida(int id_armazem, Date data_inicio, Date data_fim) {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/resumo_completo_saida_vasilhame.jasper";
