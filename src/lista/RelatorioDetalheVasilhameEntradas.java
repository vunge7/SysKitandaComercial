 ...
 */
public  class RelatorioDetalheVasilhameEntradas {

    private Date data_incio, data_fim;
    private int id_armazem = 0;

    public RelatorioDetalheVasilhameEntradas(int id_armazem, Date data_inicio, Date data_fim) {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/resumo_detalhe_entrada_vasilhame.jasper";
