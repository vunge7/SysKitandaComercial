 ...
 */
public class RelatorioTransferenciaArmazem extends javax.swing.JFrame
{
    ...
    public RelatorioTransferenciaArmazem( int idUser, BDConexao conexao )
    {
        initComponents();
        setResizable( false );
    ...
    private void initComponents()
    {
        ...
        lbData2.setText("RELATÓRIO DE TRANSFERÊNCIA DE ARMAZÉM");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        {
            Logger.getLogger( RelatorioTransferenciaArmazem.class.getName() ).log( Level.SEVERE, null, ex );
        }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( RelatorioTransferenciaArmazem.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
    ...
    public void mostrar() throws SQLException
    {
        ...
        String nome = "sdf".toLowerCase();
        new AnyReport( hashMap, "relatorio_transferencia.jasper" );
