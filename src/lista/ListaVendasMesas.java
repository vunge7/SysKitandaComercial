...
//    private DVML.Abreviacao doc_breviacao;
    ...
    public ListaVendasMesas( int cod_venda, Abreviacao doc_abrevicao, int cod_mesa, int pk_lugar, boolean performance, boolean a5, String status_documento )
    {
...
//             printReportToPrinter("factura_A5_1_pedidos.jrxml", impressora2);
        ...
        {
            Logger.getLogger(ListaVendasMesas.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//    public ListaVenda( int codigo, boolean performance, boolean a5, String status_documento )
    public ListaVendasMesas( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean a5, String status_documento )
    {
        try
        {
            String impressora = "Adobe PDF";
            ...
            this.performance = performance;
            this.a5 = a5;
//            printReportToPrinter ( "ListarUsuario.jrxml", impressora );
            //printReportToPrinter ( "factura_A5_1_pedidos.jrxml", impressora3 );
//             printReportToPrinter("filtrar_sub_factura_A5_1_pedidos.jrxml", impressora2);
            mostrarVendaGeral();
        }
        catch ( Exception ex )
        {
...
//
//        private void printReportToPrinter() throws JRException {
//
//        
////        listar_impressoras();
//        
...
//        String impressdora = "EPSON TM-T88V Receipt";
//        
//        PrinterName printerName = new PrinterName(listar_impressora(impressdora), null); //gets printer 
...
//        return "relatorios/facturas_mesas_A6.jasper";
...
//        return "relatorios/factura_A5_1_pedidos.jasper";
    ...
    public static void main( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaVendasMesas( 1, abreviacao, 1, 1, false, true, "Original" );
