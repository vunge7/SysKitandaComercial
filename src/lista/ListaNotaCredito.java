...
public class ListaNotaCredito
{
    ...
    public ListaNotaCredito ( int codigo, Abreviacao doc_abrevicao, boolean performance, boolean factura_simplificada, HashMap hashMap, String motivo_isencao )
    {
...
//    }
    ...
    public void mostrarNota ( HashMap hashMap ) throws SQLException
    {
        ...
        hashMap.put ( "DOCUMENTO", notasDao.findNotas ( codigo ).getFkDocumento ().getDesignacao () );
...
//            case NC:
//            {
                return CAMINHO_REPORT + "notaCreditoDebito2.jasper";
//                return CAMINHO_REPORT + "not.jasper";
//            }
//            case ND:
//            {
...
//        }
    ...
    public static void main ( String[] args ) throws JRException, SQLException
    {
        ...
        new ListaNotaCredito ( 39, abreviacao, false, true, hashMap, "" );
