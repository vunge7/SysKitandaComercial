...
public class ReciboEntradas {
  
    private int comprovativo;
  
 
    public ReciboEntradas(int comprovativo) throws SQLException {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/entradaCaixaSegundaVia.jasper";
        ...
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "ERRO AO TENTAR MOSTRAR O RELATORIO2!");
        }

        }

    public static void main(String[] args) throws SQLException {
        ReciboEntradas reciboEntradas = new ReciboEntradas(1); 
    }
