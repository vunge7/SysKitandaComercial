...
public class ListarEntradasProdutosPorEntervaloData extends javax.swing.JFrame {
    ...
    public ListarEntradasProdutosPorEntervaloData() throws SQLException {
        ...
        cmbArmazem.setModel( new DefaultComboBoxModel( (Vector) armazemDao.getAllArmazem()   ) );      
...
//          
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ListarEntradasProdutosPorEntervaloData().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ListarEntradasProdutosPorEntervaloData.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
