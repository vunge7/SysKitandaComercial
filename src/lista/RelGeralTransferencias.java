...
public  class RelGeralTransferencias {

   
    private Date data_inicio,data_fim ;

    public RelGeralTransferencias(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        hashMap.put("DATA_INICIO", this.data_inicio);      
        hashMap.put("DATA_FIM", this.data_fim);      
//        hashMap.put("SUBREPORT_DIR", "relatorio/");
          
        //obter o path do relatorio
        String relatorio = "relatorio/mapa_transferenciaS.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralTransferencias(new Date(), new Date());
