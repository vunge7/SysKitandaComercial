 ...
 */
public class ResumoVendaRestaurante
{
    ...
    public ResumoVendaRestaurante(   String area,  Date data_incio, Date data_fim, int id_armazem, List<TbVenda> list, int id_documento, boolean mapa_iva )
    {
...
//        if ( id_documento != DVML.DOC_FACTURA_FT )
        if ( true )
        {
            relatorio = !mapa_iva ? "relatorios/princ_relatorio_diario_restaurante.jasper" : "relatorios/mapa_iva_restaurante.jasper";
        }
        else
        {
            relatorio = !mapa_iva ? "relatorios/princ_relatorio_diario_factura_restaurante.jasper" : "relatorios/mapa_iva_restaurante.jasper";
        }
