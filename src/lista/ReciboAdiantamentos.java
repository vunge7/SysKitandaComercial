...
public class ReciboAdiantamentos {
  
    private int comprovativo;
  
 
    public ReciboAdiantamentos(int comprovativo) throws SQLException {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/adiantamentoCaixaSegundaVia.jasper";
    ...
    public static void main(String[] args) throws SQLException {
        ReciboAdiantamentos reciboEntradas = new ReciboAdiantamentos(6); 
    }
