...
public  class RelMapaBalanco {

   
    private Date data_inicio,data_fim ;

    public RelMapaBalanco(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/MAPA_BALANCO.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelMapaBalanco(new Date(), new Date());
