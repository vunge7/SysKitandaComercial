...
public  class RelGeralContas {

   
    private Date data_inicio,data_fim ;
    private int id_banco  = 0;

    public RelGeralContas(int id_banco, Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorios/Princ_Relatorio_Contas.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralContas(1, new Date(), new Date());
