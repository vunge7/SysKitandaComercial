...
//    private boolean editarPreco;
    ...
    public String getSegundoMonitor() {
        return segundoMonitor;
    }

    public void setSegundoMonitor(String segundoMonitor) {
        this.segundoMonitor = segundoMonitor;
    }

    public String getImpressoraCaixa() {
        return impressoraCaixa;
    }

    public void setImpressoraCaixa(String impressoraCaixa) {
