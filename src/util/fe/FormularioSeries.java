...
//        } );
    ...
    private void solictarSerie() {
        ...
        String establishmentNumber = dadosInstituicaoController.findByCodigo(1).getNumeroEstabelecimento();
        ...
        Map<String, Object> jsonPayload = PayloadFactory.criarPayloadCriarSerie(
                taxRegistrationNumber, 
                establishmentNumber, 
                seriesYear, documentType);
