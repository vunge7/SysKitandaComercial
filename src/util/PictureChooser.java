...
public class PictureChooser {
    ...
    public void LoadImgDataBase(TbProduto produto, JLabel jlbImg) {
        byte[] foto = null;
        ...
        try {
            ...
            System.out.println("IMAGEM EM BYTE "  +produto.getPhoto());
              
            img = ImageIO.read( new ByteArrayInputStream( produto.getPhoto() ) );
