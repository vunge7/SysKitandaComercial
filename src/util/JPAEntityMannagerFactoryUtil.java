...
//                String ip = "localhost";
                   ...
                   //                String url = "jdbc:mysql://"   +ip +":3306/kitanda_db_kandundo_kilamba_moys_gulele_dvml_k11_joaquim?zeroDateTimeBehavior=convertToNull";
        ...
        public static EntityManagerFactory getEntityManagerFactory( String PU )
        {
            ...
            try
            {
                ...
                if ( !informacao.isEmpty() )
                {
                    ...
                    String url = "jdbc:mysql://" + ip + ":" + porta + "/kitanda_db_kandundo_kilamba?zeroDateTimeBehavior=convertToNull";
