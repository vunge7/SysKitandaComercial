...
public class ReciboActivos {

 
    public ReciboActivos() throws SQLException {
...
//      hashMap.put("SUBREPORT_DIR", "relatorios/");
        ...
        String relatorio = "relatorios/listagemActivos.jasper";
        ...
        try {
            ...
            if (jasperPrint.getPages().size() >= 1) {
                ...
                JOptionPane.showMessageDialog(null, "ATENÇÃO\nNão existem Funcionários existentes!...", "Informação", JOptionPane.WARNING_MESSAGE);
            }
...
//    }
    ...
    public static void main(String[] args) throws SQLException {
        ReciboActivos recibo = new ReciboActivos(); 
    }
