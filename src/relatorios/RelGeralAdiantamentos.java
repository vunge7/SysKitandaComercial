...
public  class RelGeralAdiantamentos {

   
    private Date data_inicio,data_fim ;

    public RelGeralAdiantamentos(Date data_inicio, Date data_fim ) 
    {
    ...
    public void mostrar() throws SQLException{
        ...
        String relatorio = "relatorio/PRINC_RELATORIO_ADIANTAMENTOS.jasper";
    ...
    public static void main(String[] args){
        ...
        new RelGeralAdiantamentos(new Date(), new Date());
