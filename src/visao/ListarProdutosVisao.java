 ...
 */
public class ListarProdutosVisao extends javax.swing.JFrame
{
    ...
    public ListarProdutosVisao( int idUser )
    {
...
//        cmbArmazem.setModel(new DefaultComboBoxModel(armazemDao.buscaTodos()));
    ...
    private void initComponents()
    {
        ...
        ck_sem_iva = new javax.swing.JCheckBox();
        ...
        buttonGroup2.add(ck_com_iva);
        ck_com_iva.setText("Com Iva");

        buttonGroup2.add(ck_sem_iva);
        ck_sem_iva.setSelected(true);
        ck_sem_iva.setText("Sem Iva");
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( ListarProdutosVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                try
                {
                    new ListarProdutosVisao( 15 ).setVisible( true );
                }
                catch ( Exception ex )
                {
                    Logger.getLogger( ListarProdutosVisao.class.getName() ).log( Level.SEVERE, null, ex );
                }
            }
        } );
    }
