 ...
 */
public class BuscaProdutoIngredientesVisao extends javax.swing.JDialog
{
    ...
    public BuscaProdutoIngredientesVisao( java.awt.Frame parent, boolean modal, int cod_armazem, int cod_janela, BDConexao conexao )
    {
        super( parent, modal );
        initComponents();
        ...
        fonte_dados = stoksController.getFonteIngredientes( cod_armazem, cod_janela );
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("BUSCA INGREDIENTES");
...
//            }
            ...
            else if ( DVML.JANELA_PRODUTO == cod_janela )
            {
                ...
                int linha = tabela_busca.getSelectedRow();
                Integer codigo = Integer.parseInt( modelo.getValueAt( linha, 0 ).toString() );
                ProdutosIngredientesVisao.ver_dados( codigo );
                dispose();
...
//            }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( BuscaProdutoIngredientesVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
