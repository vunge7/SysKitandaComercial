...
import lista.ListaVendaOficina;
 ...
 */
public class VendaOficinaUsuarioVisao extends javax.swing.JFrame
{
...
//        jLabelKilometragem.setVisible( false );
        lbCategoria.setVisible( false );
        lbCategoria1.setVisible( false );
        cmbFamilia.setVisible( false );
        cmbSubFamilia.setVisible( false );
//        jLabelKilometragem.setVisible( false );
//        txtKilometragem.setVisible( false );
        //pegarResolucao();
        VendaOficinaUsuarioVisao.conexao = conexao;

        /**
         * INSTANCIAS DOS CONTROLLER COMERCIAL
         */
        vendasController = new VendasController( VendaOficinaUsuarioVisao.conexao );
        itemVendasController = new ItemVendasController( VendaOficinaUsuarioVisao.conexao );
        mesasController = new MesasController( VendaOficinaUsuarioVisao.conexao );
        lugaresController = new LugaresController( VendaOficinaUsuarioVisao.conexao );
        produtosController = new ProdutosController( VendaOficinaUsuarioVisao.conexao );
        stocksController = new StoksController( VendaOficinaUsuarioVisao.conexao );
        precosController = new PrecosController( VendaOficinaUsuarioVisao.conexao );
        tipoProdutoController = new TipoProdutosController( VendaOficinaUsuarioVisao.conexao );
        familiaController = new FamiliasController( VendaOficinaUsuarioVisao.conexao );
        armazensController = new ArmazensController( VendaOficinaUsuarioVisao.conexao );
        localController = new LocalController( VendaOficinaUsuarioVisao.conexao );
        unidadesController = new UnidadesController( VendaOficinaUsuarioVisao.conexao );
        anoEconomicoController = new AnoEconomicoController( VendaOficinaUsuarioVisao.conexao );
        clientesController = new ClientesController( VendaOficinaUsuarioVisao.conexao );
        documentosController = new DocumentosController( VendaOficinaUsuarioVisao.conexao );
        moedasController = new MoedasController( VendaOficinaUsuarioVisao.conexao );
        descontosController = new DescontosController( VendaOficinaUsuarioVisao.conexao );
        usuariosController = new UsuariosController( VendaOficinaUsuarioVisao.conexao );
        dadosInstituicaoController = new DadosInstituicaoController( VendaOficinaUsuarioVisao.conexao );
        produtosImpostoController = new ProdutosImpostoController( VendaOficinaUsuarioVisao.conexao );
        produtosIsentoController = new ProdutosIsentoController( VendaOficinaUsuarioVisao.conexao );
        caixasController = new CaixasController( VendaOficinaUsuarioVisao.conexao );
        formaPagamentoController = new FormaPagamentoController( VendaOficinaUsuarioVisao.conexao );
        armazensAccessoController = new ArmazensAccessoController( VendaOficinaUsuarioVisao.conexao );
        cambiosController = new CambiosController( VendaOficinaUsuarioVisao.conexao );
        formaPagamentoItemController = new FormaPagamentoItemController( VendaOficinaUsuarioVisao.conexao );
        servicosRetencaoController = new ServicosRetencaoController( VendaOficinaUsuarioVisao.conexao );
        contaController = new ContaController( VendaOficinaUsuarioVisao.conexao );
...
//        habilitarColunas();
    ...
    private void initComponents()
    {
        ...
        txtAreaAvaria = new javax.swing.JTextArea();
        ...
        jPanel8.add(txtTotal_AOA_liquido, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, 320, 25));
        ...
        jPanel8.add(cmbMoeda, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 70, 110, -1));
        ...
        jPanel8.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 70, 50, -1));
        ...
        jPanel3.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 40, 70, 40));
        ...
        jPanel3.add(btnFormaPagamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 210, 40));
        ...
        jPanel3.add(btnProcessar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 170, 40));
        ...
        jPanel3.add(txtObs, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 270, 40));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 0, 150, 40));
        ...
        jPanel4.add(lbCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 100, 10));

        lbCodigoProduto.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbCodigoProduto.setText("CodArt:");
        jPanel4.add(lbCodigoProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 60, 30));
        ...
        jPanel4.add(txtCodigoProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 60, 30));
        ...
        jPanel4.add(lbProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 50, 20));

        lbQuantidade.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbQuantidade.setText("Qtd:");
        jPanel4.add(lbQuantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 39, 30));
        ...
        jPanel4.add(btn_remover, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 50, 40));

        lbQuantidadeStock.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbQuantidadeStock.setText("Q.Stock:");
        jPanel4.add(lbQuantidadeStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, 70, 30));

        lbCodigoProduto1.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbCodigoProduto1.setText("CodBarra:");
        jPanel4.add(lbCodigoProduto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 100, 20));
        ...
        jPanel4.add(txtCodigoBarra, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 180, 20));
        ...
        jPanel4.add(cmbSubFamilia, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 360, 10));
        ...
        jPanel4.add(cmbProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 380, 20));
        ...
        jPanel4.add(txtQuantidadeStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 80, 50));
        ...
        jPanel4.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 160, 40, 40));
        ...
        jPanel4.add(txtPreco, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 130, 30));
        ...
        jPanel4.add(txtQuatindade, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 90, 30));

        lbCodigoProduto2.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbCodigoProduto2.setText("CodManual:");
        jPanel4.add(lbCodigoProduto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 100, 20));
        ...
        jPanel4.add(txtCodigoManual, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 180, 20));
        ...
        jPanel4.add(cmbFamilia, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, 360, 10));
        ...
        jPanel4.add(lbCategoria1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 100, 10));

        lbPreco1.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbPreco1.setText("Preco:");
        jPanel4.add(lbPreco1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 50, 30));
        ...
        jPanel4.add(btn_adicionar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 50, 40));
        ...
        jPanelDataLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDataLayout.createSequentialGroup()
                .addComponent(cmbAnoEconomico, 0, 119, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(rbArmazem1)
                .addGap(18, 18, 18)
                .addComponent(rbArmazem)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbArmazem, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel4.add(ck_A4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 50, -1));
        ...
        jPanel4.add(ck_simplificada, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 50, -1));
        ...
        jPanel4.add(ck_A7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, -1, -1));
        ...
        jPanel4.add(ck_Duplicada, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, -1, -1));

        jlStockNegativo1.setForeground(new java.awt.Color(153, 0, 51));
        jlStockNegativo1.setText("Formato ");
        jPanel4.add(jlStockNegativo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, -1, 20));
        ...
        jPanel4.add(ck_ComVirgula, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 210, 55, -1));
        ...
        jPanel4.add(ck_S_A6, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, -1, -1));
        ...
        jPanel4.add(ck_simplificada_O_S, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, -1, -1));
        ...
        jPanel4.add(ck_simplificada_O, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 210, -1, -1));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar Clientes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 0, 0))); // NOI18N
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtIniciaisCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGap(15, 15, 15)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNifClientePesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lbClienteConsumidorFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addComponent(txtCodClientePesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNomeConsumidorFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanelCaracteristicas.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Características da Viatura", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        txtNumeroChassi.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
        txtNumeroChassi.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                txtNumeroChassiActionPerformed(evt);
            }
        });
        ...
        jLabel9.setText("Nº Chassi:");

        jLabel10.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        jLabel10.setText("Cor:");

        jLabel12.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        jLabel12.setText("Ano Fabrico:");

        txtAnoFabrico.setFont(new java.awt.Font("Lucida Grande", 0, 12)); // NOI18N
            ...
            .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                ...
                .addGroup(jPanelCaracteristicasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNumeroChassi, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanelCaracteristicasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                                ...
                                .addGap(12, 12, 12)
                                .addComponent(txtKilometragem, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelCaracteristicasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtAnoFabrico, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lbPreco2, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(4, 4, 4)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(txtReferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(dc_data_documento, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(rbMostrar, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jlStockNegativo, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(rbTranstorno, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(lbVias, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lbPreco3.setFont(new java.awt.Font("Lucida Grande", 1, 12)); // NOI18N
        lbPreco3.setText("Documento:");
        ...
        txtAreaAvaria.setColumns(20);
        txtAreaAvaria.setRows(5);
        txtAreaAvaria.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Descrição de Avarias", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(204, 0, 51))); // NOI18N
        jScrollPane2.setViewportView(txtAreaAvaria);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(lbPreco3, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cmbTipoDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(lb_proximo_documento, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//        configurar_armazens();
    ...
    private void txtNumeroChassiActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_txtNumeroChassiActionPerformed
    {//GEN-HEADEREND:event_txtNumeroChassiActionPerformed
        txtQuatindade.requestFocus();
    }//GEN-LAST:event_txtNumeroChassiActionPerformed
...
//        }
    ...
    {//GEN-HEADEREND:event_txtAnoFabricoActionPerformed
        // TODO add your handling code here:
    ...
    private static javax.swing.JTextField txtAnoFabrico;
    private static javax.swing.JTextArea txtAreaAvaria;
    ...
    private static javax.swing.JTextField txtCor;
    ...
    private javax.swing.JTextField txtNifClientePesquisa;
    private static javax.swing.JTextField txtNomeConsumidorFinal;
    private static javax.swing.JTextField txtNumeroChassi;
...
//        TbProduto findByCod = produtosController.findByCod( codigo_produto);
//        Integer codSubFamilia = findByCod.getCodTipoProduto().getCodigo();
//        TbTipoProduto subfamilia =   (TbTipoProduto)tipoProdutoController.findById( codSubFamilia);
//        Integer idFamilia = subfamilia.getFkFamilia().getPkFamilia();
//        boolean editavelPreco = (idFamilia == 1);
        if ( true )
        {
...
//        {
            ...
            if ( !validar_zero() )
            {
                ...
                String precoUnitario = CfMethods.formatarComoMoeda( getPreco() );
...
//            if ( findByDesignacao.getCozinha().equals( DVML.ENVIAR_TICKET ) || findByDesignacao.getCozinha().equals( DVML.ENVIAR_SALA) )
...
//        txtQuatindade.setText( "1" );
    ...
    public static void adicionar_produto2() throws SQLException
    {
...
//        {
        if ( true )
        {
            ...
            if ( !validar_zero() )
            {
                ...
                double preco = 0;
                System.out.println( "$$$$ PRECO: " + preco );
                double taxa = getTaxaImpostoIva( 0 );
                double ret = getTaxaImpostoRet( 0 );
                System.out.println( "RET: " + ret );
                System.out.println( "TAX: " + taxa );
                String precoUnitario = CfMethods.formatarComoMoedaPreco( 0.00 );
//              ( double qtd, double taxa, double preco_venda, double desconto )
                String total_linha_retencao = CfMethods.formatarComoMoeda( getValorComRetencao(
                        qtd,
                        ret,
                ...
                String total_iliquido_linha = CfMethods.formatarComoMoeda( getTotal2() );
                String total_liquido_linha = CfMethods.formatarComoMoeda( getValorComImpostoIva(
                        qtd,
                        taxa,
                        preco,
...
//                int last_id_item_venda = itemVendaDao.criarComProcedimentos( itemVenda, conexao );
        ...
        if ( efectuada )
        {
            ...
            txtQuatindade.setText( "1" );
            txtIniciaisCliente.requestFocus();
            txtQuantidadeStock.setText( String.valueOf( conexaoTransaction.getQtdExistenteStock( getCodigoProduto(), getCodigoArmazem() ) ) );
            conexaoTransaction.close();
            ...
            for ( int i = 1; i <= numeroVias; i++ )
            {
                ...
                {
                    case 1:
                        ListaVendaOficina original = new ListaVendaOficina( cod_venda, abreviacao, false, ck_simplificada.isSelected(), "Original", motivos_isentos );
//                        ListaVenda1 original = new ListaVenda1( cod_venda, abreviacao, false, ck_simplificada.isSelected(), "Original", motivos_isentos );
                        break;
                    case 2:
                        ListaVendaOficina original_duplicado = new ListaVendaOficina( cod_venda, abreviacao, false, ck_simplificada.isSelected(), "Duplicado", motivos_isentos );
//                        ListaVenda1 original_duplicado = new ListaVenda1( cod_venda, abreviacao, false, ck_simplificada.isSelected(), "Duplicado", motivos_isentos );
                        break;
                    case 3:
                        ListaVendaOficina original_triplicado = new ListaVendaOficina( cod_venda, abreviacao, false, ck_simplificada.isSelected(), "Triplicado", motivos_isentos );
                        break;
                }
...
//        venda_local.setHashCod( MetodosUtil.criptografia_hash( prox_doc ) );
        ...
        venda_local.setNumChassi( txtNumeroChassi.getText() );
        venda_local.setMatricula( txtMatricula.getText() );
        venda_local.setMarcaCarro( txtMarca.getText() );
        venda_local.setModelo( txtModelo.getText() );

        venda_local.setCorCarro( txtCor.getText() );
        venda_local.setKilometro( txtKilometragem.getText() );
        venda_local.setNumMotor( txtAnoFabrico.getText() );
        venda_local.setNDocMotorista( txtAreaAvaria.getText() );
            ...
            if ( vendasController.salvar( venda_local ) )
            {
                ...
                if ( last_venda != null )
                {
                    ...
                    if ( getIdDocumento() == DOC_FACTURA_FT )
                    {
                        ...
                        ExtratoContaClienteController.registro_movimento_conta_cliente( venda_local, conexao );
                    }
...
//    }
    ...
    {
        new VendaOficinaUsuarioVisao( 15, new BDConexao() ).show( true );
    }
...
//        JOptionPane.showMessageDialog ( null, "Backup realizado com sucesso! ", "Notificação", JOptionPane.INFORMATION_MESSAGE );
    ...
    private void actualizarQtdTable()
    {
        ...
        if ( linha_actual > -1 )
        {
            double qtd = Double.parseDouble( table.getValueAt( linha_actual, 4 ).toString() );
...
//        actualizarPrecoVendaManual( idProduto, CfMethods.parseMoedaFormatada( precoUnitario ), precosController );
        ...
        if ( table.getSelectedColumn() == 3 )
        {
            String designacao = table.getValueAt( table.getSelectedRow(), 1 ).toString();

            int idProduto = Integer.parseInt( table.getValueAt( table.getSelectedRow(), 0 ).toString() );
            String precoLocal = table.getValueAt( table.getSelectedRow(), 3 ).toString();
            if ( idProduto == 0 )
            {

                if ( !precoLocal.equals( "0,0000000 AOA" )
                        && !precoLocal.equals( "0,00 AOA" ) )
                {
                    produto = new TbProduto();
                    preparar_produto( designacao, Double.parseDouble( precoLocal ) );

                    if ( !produtosController.exist_designacao_produto( produto.getDesignacao() ) )
                    {
                        System.out.println( "Preparado para registrar os precos." );
                        produtosController.salvar( produto );
                        idProduto = produtosController.getLastProduto().getCodigo();

                    }
                    else
                    {
                        idProduto = produtosController.getProdutoByDesignacao( designacao ).getCodigo();
                    }

                    precoLocal = precoLocal.replaceAll( "A", "" ).
                            replace( "O", "" ).
                            replace( ".", "" ).
                            replace( ",", "." );

                    String precoUnitarioLocal = CfMethods.formatarComoMoeda( Double.parseDouble( precoLocal ) );
                    System.out.println( "Preparado para registrar os precos." + precoUnitarioLocal );
                    table.setValueAt( idProduto, table.getSelectedRow(), 0 );
                    table.setValueAt( precoUnitarioLocal, table.getSelectedRow(), 3 );
...
//            precoDao.create(preco_novo_grosso);
    ...
    private boolean registrar_preco( int idProduto, PrecosController precosControllerLocal, double precoVendaParm )
    {


        /*PRIMEIRO PRECO RETALHO*/
        setDadosPreco( idProduto, precoVendaParm );
        preco.setQtdBaixo( 0 );
        preco.setQtdAlto( (int) DVML.QTD_DEFAULT - 1 );
        BigDecimal precoVenda = new BigDecimal( "0.0" );
        BigDecimal precoVendaGrosso = new BigDecimal( "0.0" );
        BigDecimal precoCompra = new BigDecimal( precoVendaParm );

        try
        {
            preco.setPrecoVenda( precoCompra );
...
//
    ...
    private void setDadosPreco( int idProduto, double precoCompra )
    {
        preco = new TbPreco();
        preco.setPrecoCompra( new BigDecimal( precoCompra ) );
        ...
        preco.setFkUsuario( new TbUsuario( cod_usuario ) );
    }

    private void preparar_produto( String designacao_produto, double precoUnico )
    {

        produto.setDesignacao( designacao_produto );
        produto.setPreco( new BigDecimal( precoUnico ) );
        ...
        produto.setPrecoVenda( precoUnico );
        ...
        produto.setCodTipoProduto( new TbTipoProduto( 1 ) );
...
//        produto.setPercentagemDesconto( 0d );
        ...
        produto.setUnidadeCompra( Double.valueOf( "0" ) );
