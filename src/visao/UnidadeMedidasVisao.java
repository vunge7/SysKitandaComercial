 ...
 */
public class UnidadeMedidasVisao extends javax.swing.JDialog
{

    private BDConexao conexao;
    private Frame parent;
    private EntityManagerFactory emf = JPAEntityMannagerFactoryUtil.em;
    private UnidadeDao unidadeDao = new UnidadeDao( emf );
    private Unidade unidade;
    private int codigo = 0;

    public UnidadeMedidasVisao( java.awt.Frame parent, boolean modal )
    {
...
//        lbLocal.setHorizontalAlignment(JLabel.RIGHT);
//       
//      
//       
...
//    
    ...
    private void initComponents() {
        ...
        lbTipoProduto.setText("Nova Unidade:");

        txtUnidade.setBackground(new java.awt.Color(51, 153, 0));
        txtUnidade.setForeground(new java.awt.Color(255, 255, 255));
        txtUnidade.setCaretColor(new java.awt.Color(255, 255, 255));

        lbTipoProduto1.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 16)); // NOI18N
        lbTipoProduto1.setText(" Abreviação:");

        txtAbreviacao.setBackground(new java.awt.Color(51, 153, 0));
        txtAbreviacao.setForeground(new java.awt.Color(255, 255, 255));
        txtAbreviacao.setCaretColor(new java.awt.Color(255, 255, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtUnidade, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtAbreviacao, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(UnidadeMedidasVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                UnidadeMedidasVisao dialog = new UnidadeMedidasVisao( new javax.swing.JFrame(), true );
 ...
 /*VALIDACOES */
    ...
    public boolean campos_invalidos()
    {
        ...
        if ( getLocal().equals( "" ) )
        {
            txtUnidade.setBackground( backGround );
            txtUnidade.setForeground( foreGround );
            txtUnidade.setCaretColor( caretColor );
            JOptionPane.showMessageDialog( null, "Pf. Preêncha a Unidadew: " );
            return true;
        }
        else if ( getLocal().equals( "" ) )
        {
            txtAbreviacao.setBackground( backGround );
            txtAbreviacao.setForeground( foreGround );
            txtAbreviacao.setCaretColor( caretColor );
            JOptionPane.showMessageDialog( null, "Pf. Preêncha a Abreviação da Unidade: " );
            return true;
        }
...
//           tipoProdutoModelo = new LocalModelo(codigo,getLocal());  
//           if(operacao!=3)
//           {
//                 
...
//    }
    ...
    private void adicionar()
    {
        ...
        List<Unidade> list = unidadeDao.getAll();

        modelo.setRowCount( 0 );
        for ( int i = 0; i < list.size(); i++ )
        {

            Unidade unidade = list.get( i );
            modelo.addRow(
                    new Object[]
                    {
    ...
    private void setDados()
    {
        ...
        this.unidade.setDescricao(txtUnidade.getText() );
        this.unidade.setAbreviacao(txtAbreviacao.getText() );
    ...
    private void procedimento_salvar()
    {
        ...
        if ( valido() )
        {
            ...
            if ( !unidadeDao.exist(txtUnidade.getText() ) )
            {
                ...
                try
                {
                    ...
                    limpar();
                    adicionar();
                    JOptionPane.showMessageDialog( null, "Unidade salva com sucesso!...", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );
                }
                catch ( Exception e )
                {
                    JOptionPane.showMessageDialog( null, "Erro ao salvar a Unidade", DVML.DVML_COMERCIAL, JOptionPane.ERROR_MESSAGE );
                }

            }
            else
            {
                JOptionPane.showMessageDialog( null, "Já existe uma unidade com esta designação", DVML.DVML_COMERCIAL, JOptionPane.WARNING_MESSAGE );
            }
    ...
    private void procedimento_alterar()
    {
        ...
        if ( valido() )
        {
            ...
            this.unidade = unidadeDao.findUnidade(this.codigo );
            setDados();
            try
            {
                unidadeDao.edit( unidade );
                limpar();
                adicionar();
                JOptionPane.showMessageDialog( null, "Unidade alterada com sucesso!...", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );
            }
            catch ( Exception e )
            {
                JOptionPane.showMessageDialog( null, "Erro ao alterar a unidade", DVML.DVML_COMERCIAL, JOptionPane.ERROR_MESSAGE );
            }
    ...
    {
        int opcao = JOptionPane.showConfirmDialog( null, "Tens a plena certeza que pretendes eliminar essa unidade?" );
        ...
        if ( opcao == JOptionPane.YES_OPTION )
        {
            ...
            try
            {
                ...
                unidadeDao.destroy( this.codigo );
                adicionar();
                limpar();
                JOptionPane.showMessageDialog( null, "Unidade eliminada com sucesso!...", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );
            ...
            catch ( Exception e )
            {
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog( null, "Erro ao eliminar essa unidade.\nPossivelmente já está realcionado com alguns produtos", DVML.DVML_COMERCIAL, JOptionPane.ERROR_MESSAGE );
            }

        }
        else
        {
            JOptionPane.showMessageDialog( null, "Unidade não eliminada", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );
        }
    ...
    private boolean valido()
    {
        ...
        if ( txtUnidade.equals( "" ) )
        {

            txtUnidade.requestFocus();
            JOptionPane.showMessageDialog( null, "Pf. digite a unidade", DVML.DVML_COMERCIAL, JOptionPane.WARNING_MESSAGE );
            return false;
    ...
    private void mostar_dados()
    {
        ...
        this.unidade = unidadeDao.findUnidade(this.codigo );
        txtUnidade.setText( this.unidade.getDescricao());
        txtAbreviacao.setText( this.unidade.getAbreviacao());
