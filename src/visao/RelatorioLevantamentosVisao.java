...
import lista.RelGeralDepositos;
//import relatorios.RelGeralPropinas;
import lista.RelGeralEntradas;
import lista.RelGeralLevantamentos;
 ...
 * @author Toshiba
 */
public class RelatorioLevantamentosVisao extends javax.swing.JFrame {
...
//    private BancoDao bancoDao = new BancoDao(emf);
    ...
    public RelatorioLevantamentosVisao() {
    ...
    private void initComponents()
    {
        ...
        jLabel3.setText("RELATÓRIO GERAL DE LEVANTAMENTOS BANCÁRIOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioLevantamentosVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    {
        List<LevantamentoBancario> lista;
...
//                lista = reciboPropinasDao.getAllReciboPropinaByIdBancoAndData(dcDataInicio.getDate(), dcDataFim.getDate() );
            lista = levantamentoBancarioDao.getAllLevantamentosByDataInicioDataFim(dcDataInicio.getDate(), dcDataFim.getDate() );
            
            
            try {
                
                for (LevantamentoBancario object : lista) {
                    
                        modelo.addRow(  new Object[]
                        {
                                    object.getPkLevantamento(),
                                    object.getObs(),
                                    object.getData(),
...
//              {
                      new RelGeralLevantamentos( dcDataInicio.getDate() , dcDataFim.getDate() );
