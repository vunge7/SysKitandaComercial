 ...
 */
public class ReemprimirNotaVisao extends javax.swing.JFrame
{
...
//    private NotasDao notasDao = new NotasDao( emf );
    ...
    public ReemprimirNotaVisao( java.awt.Frame parent, boolean modal, BDConexao conexao )
    {
        //this.parent =  parent1;
        this.parent = parent;
...
//        rb_A6.setVisible( false );
    ...
    private void initComponents()
    {
        ...
        setTitle("...::::: DVML-REIMPRIMIR_NOTAS ::::...");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Nota Credito"));

        buttonGroup1.add(rbNC);
    ...
    {//GEN-HEADEREND:event_rbNCActionPerformed
        // TODO add your handling code here:
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(ReemprimirNotaVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
...
//        TbVenda venda = vendaDao.findByCodFactReemprensao( ref_doc );
        TbVenda vendas = vendaDao.findByCodFactReemprensao( ref_doc );
        System.out.println("NOTA: "+vendas );
        if ( vendas != null )
        {
//            Abreviacao abreviacao = DVML.getAbreviacao( venda.getFkDocumento().getPkDocumento() );
            Abreviacao abreviacao = DVML.getAbreviacao(vendas.getFkDocumento().getPkDocumento() );
...
//            abreviacao = rbR.isSelected() ? DVML.Abreviacao.RC : abreviacao;
            abreviacao = rbNC.isSelected() ? DVML.Abreviacao.NC : abreviacao;
...
//            ListaVenda2 listaVenda1 = new ListaVenda2( venda.getCodigo(), abreviacao, false, false, SEGUNDA_VIA_CONFORMIDADE_COM_ORIGINAL, motivos_isentos );
            ListaNotaDebito listaVenda2 = new ListaNotaDebito( vendas.getCodigo(), abreviacao, false, true, hashMap, motivos_isentos );
