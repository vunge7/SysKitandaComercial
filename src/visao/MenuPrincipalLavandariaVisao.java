 ...
 *
 */
public class MenuPrincipalLavandariaVisao extends javax.swing.JFrame
{
    ...
    public MenuPrincipalLavandariaVisao( int cod, int id_empresa, boolean administrador, BDConexao conexao )
    {
...
//        jmAnulamentoEntradaProdutos.setVisible( false );
        ...
        this.setExtendedState( this.getExtendedState() | MenuPrincipalLavandariaVisao.MAXIMIZED_BOTH );
...
//        jmGestaoMesas.setEnabled( status );
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem_layout/layout_lavandaria4.jpg"))); // NOI18N
        ...
        jMenu2.add(jmRelatorioComprasPorFornecedor);
        ...
        jMenuItem5.setText("Gerar SAFT de Inventário");
    ...
    private void jmVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmVendaActionPerformed
        ...
        {
            Logger.getLogger( MenuPrincipalLavandariaVisao.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//        new ReciboVisao( cod_utilizador, this.conexao ).setVisible( true );
    ...
    {//GEN-HEADEREND:event_jmReeprmirFacuraActionPerformed
        ...
        new ReemprimirFacturasVisao( this, rootPaneCheckingEnabled, this.conexao ).setVisible( true );
...
//        relatorioAcertoStockVisualizar();
    ...
    {//GEN-HEADEREND:event_jmFrontOfficeActionPerformed
        // TODO add your handling code here:
        new FrontOfficeLavandariaVisao( cod_utilizador, BDConexao.getInstancia()).setVisible(true);
//        new PosVisao("", cod_utilizador, this.conexao ).co( true );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MenuPrincipalLavandariaVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
