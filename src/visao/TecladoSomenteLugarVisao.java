 ...
 */
public class TecladoSomenteLugarVisao extends javax.swing.JDialog
{
    ...
    public TecladoSomenteLugarVisao( java.awt.Frame parent, boolean modal, int lugar )
    {
        super( parent, modal );
        initComponents();
...
//        setLocation( ( int ) parent.getX() + ( parent.getWidth() / 3 ), parent.getHeight() / 2 );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(TecladoSomenteLugarVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new TecladoSomenteLugarVisao( new JFrame(), true, 2 ).setVisible( true );
            }
        } );
    }
