 ...
 */
public class TecladoLugarVisao extends javax.swing.JDialog
{
    ...
    public TecladoLugarVisao( java.awt.Frame parent, boolean modal, JTable tabela, int linha, int coluna, int formulario )
    {
        super( parent, modal );
        initComponents();
...
//        setLocation( ( int ) parent.getX() + ( parent.getWidth() / 3 ), parent.getHeight() / 2 );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(TecladoLugarVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new TecladoLugarVisao( new JFrame(), true, null, 0, 0, 0 ).setVisible( true );
            }
        } );
    }
