 ...
 */
public class FormaPagamentoLugarVisao extends javax.swing.JFrame
{
     ...
     * @param modal
     */
    public FormaPagamentoLugarVisao( java.awt.Frame parent, boolean modal, EntityManagerFactory em, int formulario, BDConexao conexao, int lugar, double totalFactura )
    {
//        super( parent, modal );
        initComponents();
...
//    }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( FormaPagamentoLugarVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
