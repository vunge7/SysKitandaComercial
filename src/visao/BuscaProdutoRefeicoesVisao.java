 ...
 */
public class BuscaProdutoRefeicoesVisao extends javax.swing.JDialog
{
    ...
    public BuscaProdutoRefeicoesVisao( java.awt.Frame parent, boolean modal, int cod_armazem, int cod_janela, BDConexao conexao )
    {
        super( parent, modal );
        initComponents();
        ...
        fonte_dados = stoksController.getFonteRefeicao( cod_armazem, cod_janela );
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("BUSCA DE PRATOS");
    ...
    private void tabela_buscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_buscaMouseClicked
        ...
        if ( evt.getClickCount() == 2 )
        {
            ...
            else if ( DVML.JANELA_FICHA_TECNICA == cod_janela )
            {
                ...
                int linha = tabela_busca.getSelectedRow();
                Integer codigo = Integer.parseInt( modelo.getValueAt( linha, 0 ).toString() );
                FichaTecnicaVisao.busca_produto_by_cod_interno_refeicao( codigo );
                dispose();
...
//            }
            ...
            else if ( DVML.JANELA_PRODUTO == cod_janela )
            {
                ...
                int linha = tabela_busca.getSelectedRow();
                Integer codigo = Integer.parseInt( modelo.getValueAt( linha, 0 ).toString() );
                ProdutosPratosVisao.ver_dados( codigo );
                dispose();
...
//            }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( BuscaProdutoRefeicoesVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
