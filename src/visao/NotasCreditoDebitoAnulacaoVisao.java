 ...
 */
public class NotasCreditoDebitoAnulacaoVisao extends javax.swing.JFrame implements Runnable {
...
//    private BancoDao bancoDao;
    ...
    public NotasCreditoDebitoAnulacaoVisao(int cod_usuario, BDConexao conexao) throws SQLException {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        this.cod_usuario = cod_usuario;
        this.conexao = conexao;
        produtosController = new ProdutosController(NotasCreditoDebitoAnulacaoVisao.conexao);
        tipoProdutosController = new TipoProdutosController(NotasCreditoDebitoAnulacaoVisao.conexao);
        setWindowsListener();
        init();
    }

//    public NotasCreditoDebitoAnulacaoVisao( int cod_usuario, int codVenda, Hospedaria hospedaria, BDConexao conexao )
//    {
//        initComponents();
//        setLocationRelativeTo( null );
//        setResizable( false );
...
//            TbVenda venda = ( TbVenda ) vendasController.findById( codVenda );
//            mostrar( venda.getCodFact() );
//
...
//    }
    ...
    private void initComponents()
    {
        ...
        setTitle("...:::::  KITANDA - Anulação de Vendas ::::...");
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbTotalPagar, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(lbValorEnregue, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lbValorEnregue, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//                nota_local.setTotalVenda( venda_local.getTotalVenda() );
//                nota_local.setPerformance( "false" );
//                nota_local.setCredito( "false" );
//                nota_local.setValorEntregue( venda_local.getValorEntregue() );
//                nota_local.setTroco( venda_local.getTroco() );
//                nota_local.setIdArmazemFK( venda_local.getIdArmazemFK() );
//                nota_local.setDataVenda( new Date() );
//                nota_local.setHora( new Date() );
//                nota_local.setDataVencimento( venda_local.getDataVencimento() );
//                //Dados do cliente
...
//
//                nota_local.setDescontoTotal( venda_local.getDescontoTotal() );
//                nota_local.setTotalGeral( venda_local.getTotalGeral() );
...
//                nota_local.setTotalIva( venda_local.getTotalIva() );
...
//                nota_local.setRefDataFact( venda_local.getDataVenda() );
//                System.out.println( "STATUS:documento assinado com sucesso." );
//                nota_local.setDescontoComercial( venda_local.getDescontoComercial() );
//                nota_local.setDescontoFinanceiro( venda_local.getDescontoFinanceiro() );
//                nota_local.setTotalIncidencia( venda_local.getTotalIncidencia() );
//                nota_local.setTotalIncidenciaIsento( venda_local.getTotalIncidenciaIsento() );
//
...
//                try
//                {
//                    Integer last_nota = VendaDao.criarVendaComProcedu( nota_local, conexao );
//
//                    System.out.println( "STATUS:factura criada com sucesso." );
//                    boolean documentosalvoComSucesso = salvarItemNotaAnulamento( last_nota, venda_local );
//
...
//                        lista_produto_isentos = getProdutosIsentos( venda_local );
...
//    }
   ...
   public void anularFaturaNota() {
        ...
        // ---- Bloco transacional: cabeçalho + itens + efeitos colaterais são atómicos ----
        Connection conn = null;
        boolean autoCommitOriginal = true;

        try {
            conn = conexao.getConnectionAtiva();
            autoCommitOriginal = conn.getAutoCommit();
            conn.setAutoCommit(false);

            Integer last_nota = VendaDao.criarVendaComProcedu(nota_local, conexao);
            if (last_nota == null) {
                throw new Exception("Não foi possível criar o cabeçalho da nota (procedimento VENDA_CRIAR não retornou ID).");
            }
            System.out.println("STATUS:factura criada com sucesso.");

            // Lança exceção se algum item falhar — não engole erro nem continua sem o item
            salvarItemNotaAnulamento(last_nota, venda_local);

            // NOTA: registro_movimento_conta_cliente já é feito dentro de criarVendaComProcedu
            // para FT/RC, por isso não é repetido aqui (evita duplicidade no extrato do cliente).
            alterarStatusVenda(venda_local);

            if (venda_local.getFkDocumento().getPkDocumento() == DVML.DOC_RECIBO_RC) {
                //eliminar as armotizações da referência do documento
                TbVenda vendaRef = VendaDao.findByCodFact(venda_local.getRefCodFact());
                if (!Objects.isNull(vendaRef)) {
                    eliminar_amortizacoes(vendaRef.getCodigo());
                }
            }
...
//            actualizar_cod_doc();
            ...
            List<TbProduto> lista_produto_isentos = getProdutosIsentos(venda_local);
            String motivos_isentos = MetodosUtil.getMotivoIsensaoProdutos(lista_produto_isentos);
            System.err.println("MOTIVOS: " + motivos_isentos);
            ...
            // Confirma tudo (cabeçalho + itens + efeitos colaterais) de uma só vez
            conn.commit();
            ...
            JOptionPane.showMessageDialog(null,
                    "Falha ao processar a factura: " + e.getMessage(),
...
//            itemVendaLocal.setCodigoVenda(new TbVenda(last_cod));
...
//            itemVendaLocal.setDataServico(itemDocumentos.getDataServico());
//            itemVendaLocal.setTotal(itemDocumentos.getTotal());
//            itemVendaLocal.setFkLugares(itemDocumentos.getFkLugares());
//            itemVendaLocal.setFkMesas(itemDocumentos.getFkMesas());
//
//            itemVendaLocal.setFkPreco(itemDocumentos.getFkPreco());
//
//            try {
//                //cria o item notas
//                itemVendaDao.criarComProcedimentos(itemVendaLocal, conexao);
//                this.stock_local = stockDao.get_stock_by_id_produto_and_id_armazem(
//                        itemVendaLocal.getCodigoProduto().getCodigo(),
//                        documentoParm.getIdArmazemFK().getCodigo());
//
//                if (documentoParm.getFkDocumento().getPkDocumento() == DOC_FACTURA_RECIBO_FR
//                        || documentoParm.getFkDocumento().getPkDocumento() == DOC_FACTURA_FT) {
...
//                                documentoParm.getIdArmazemFK().getCodigo(),
//                                cod_usuario,
//                                new BigDecimal(itemVendaLocal.getQuantidade()),
//                                prox_doc,
//                                "ENTRADA",
//                                conexao
//                        );
//                        MetodosUtil.adiciona_quantidade(itemVendaLocal.getCodigoProduto().getCodigo(),
//                                itemDocumentos.getQuantidade(), getVenda().getIdArmazemFK().getCodigo(), conexao);
//                    }
//                }
//
//            } catch (Exception e) {
...
//    }
   ...
   public void salvarItemNotaAnulamento(int last_cod, TbVenda documentoParm) throws Exception {
        List<TbItemVenda> itensDocumento = documentoParm.getTbItemVendaList();

        if (itensDocumento == null || itensDocumento.isEmpty()) {
            throw new Exception("A venda de origem não tem itens associados — nada para transferir para a nota.");
        }

        for (TbItemVenda itemDocumentos : itensDocumento) {
            String produtoDescricao = itemDocumentos.getCodigoProduto() != null
                    ? String.valueOf(itemDocumentos.getCodigoProduto().getCodigo())
                    : "desconhecido";

            // Validação prévia — evita NullPointerException silencioso dentro do DAO
            if (itemDocumentos.getFkPreco() == null) {
                throw new Exception("Item do produto " + produtoDescricao + " está sem preço (fkPreco) definido.");
            }
            if (itemDocumentos.getFkLugares() == null) {
                throw new Exception("Item do produto " + produtoDescricao + " está sem 'lugar' (fkLugares) definido.");
            }
            if (itemDocumentos.getFkMesas() == null) {
                throw new Exception("Item do produto " + produtoDescricao + " está sem 'mesa' (fkMesas) definida.");
            }
            ...
            itemVendaLocal.setFkMesas(itemDocumentos.getFkMesas());
            itemVendaLocal.setFkPreco(itemDocumentos.getFkPreco());
            // campos que antes ficavam nulos e iam como "null" literal para o SQL:
            itemVendaLocal.setCodigoIsensao(itemDocumentos.getCodigoIsensao());
            itemVendaLocal.setValorRetencao(itemDocumentos.getValorRetencao());
            itemVendaLocal.setDesignacaoItem(itemDocumentos.getDesignacaoItem());

            // Sem try/catch aqui: se falhar, a exceção propaga e a transação
            // no chamador (anularFaturaNota) faz rollback de tudo.
            itemVendaDao.criarComProcedimentos(itemVendaLocal, conexao);
            ...
            if (documentoParm.getFkDocumento().getPkDocumento() == DOC_FACTURA_RECIBO_FR
                    || documentoParm.getFkDocumento().getPkDocumento() == DOC_FACTURA_FT) {
                // só adiciona caso existir o produto no armazém em questão.
                if (Objects.nonNull(stock_local)) {
                    MovimentacaoController.registrarMovimento(
                            itemVendaLocal.getCodigoProduto().getCodigo(),
                            documentoParm.getIdArmazemFK().getCodigo(),
...
//        }
    ...
    private void alterarStatusVenda(TbVenda venda) {
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("Falha ao alterar o status da factura." + e.getMessage());
//            e.printStackTrace();
        }
    ...
    private void mostrar(String ref_doc) {
...
//                            && venda_local.getDataVenda().getMonth() == new Date().getMonth() )
                    if (MetodosUtil.mesmoMesData(venda_local.getDataVenda(), new Date())) {
                        if (venda_local.getStatusEliminado().equals("false")) {
                            ...
                            //@4.setar o total
                            lbTotalPagar.setText("Total Iliquido: " + CfMethods.formatarComoMoeda(venda_local.getTotalVenda()));
    ...
    private void actualizarQtdTable() {
        ...
        if (linha_actual > -1) {
            ...
            try {
                qtd = Double.parseDouble(table.getValueAt(linha_actual, 3).toString());
            } catch (NumberFormatException e) {
                resetValue("Erro de formatação da quantidade.\nAtenção: Tem que ser número.", 3);
                return;
            }
