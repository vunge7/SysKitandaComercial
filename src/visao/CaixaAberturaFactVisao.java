 ...
 */
public class CaixaAberturaFactVisao extends javax.swing.JFrame {
    ...
    public CaixaAberturaFactVisao(int idUser, BDConexao conexao, boolean touch) {
        initComponents();
...
//        dadosInstituicaoController = new DadosInstituicaoController( CaixaAberturaVisao.conexao );
        caixa_controller = new CaixasController(CaixaAberturaFactVisao.conexao);
        item_caixa_controller = new ItemCaixaController(CaixaAberturaFactVisao.conexao);
        formaPagamentoItemController = new FormaPagamentoItemController(CaixaAberturaFactVisao.conexao);
        formaPagamentoController = new FormaPagamentoController(CaixaAberturaFactVisao.conexao);
        usuariosController = new UsuariosController(CaixaAberturaFactVisao.conexao);
        vendasController = new VendasController(CaixaAberturaFactVisao.conexao);
...
//        fazerBackupAgora();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaixaAberturaFactVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaixaAberturaFactVisao(15, BDConexao.getInstancia(), false).setVisible(true);
            }
        });
    }
