 ...
 * @author Toshiba
 */
public class RelatorioDepositosVisao extends javax.swing.JFrame {
...
//    private BancoDao bancoDao = new BancoDao(emf);
    ...
    public RelatorioDepositosVisao() {
    ...
    private void initComponents()
    {
        ...
        jLabel3.setText("RELATÓRIO GERAL DE DEPÓSITOS BANCÁRIOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioDepositosVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                lista = reciboPropinasDao.getAllReciboPropinaByIdBancoAndData(dcDataInicio.getDate(), dcDataFim.getDate() );
            lista = depositoBancariaDao.getAllDepositosByDataInicioDataFim(dcDataInicio.getDate(), dcDataFim.getDate() );
            
            
            try {
                
                for (DepositoBancario object : lista) {
                    
                        modelo.addRow(  new Object[]
                        {
                                    object.getPkDeposito(),
                                    object.getDescricao(),
                                    object.getData(),
...
//              {
                      new RelGeralDepositos( dcDataInicio.getDate() , dcDataFim.getDate() );
