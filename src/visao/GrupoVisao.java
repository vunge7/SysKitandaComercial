 ...
 */
public class GrupoVisao extends javax.swing.JFrame
{

    private EntityManagerFactory emf = JPAEntityMannagerFactoryUtil.em;
    private Grupo grupo;
    private GrupoDao grupoDao = new GrupoDao( emf );
    ...
    private void adicionar_tabela( List<Grupo> grupo )
    {
        ...
        for ( int i = 0; i < grupo.size(); i++ )
        {
            ...
            {
                grupo.get( i ).getPkGrupo(),
                grupo.get( i ).getDesignacao()
    ...
    {
        adicionar_tabela( grupoDao.buscaTodosGrupos() );
    }
    ...
    public void salvar()
    {
        ...
        if ( !vazios_campos() )
        {
            ...
            if ( !grupoDao.exist_grupo( this.descricao ) )
            {
                try
                {
                    grupo = new Grupo();
                ...
                {
                    JOptionPane.showMessageDialog( null, "Erro ao cadastrar o grupo ", "ERRO", JOptionPane.ERROR_MESSAGE );
                }

            }
            else
            {
                JOptionPane.showMessageDialog( null, "Este grupo ja existe", "AVISO", JOptionPane.WARNING_MESSAGE );
            }
        }
        else
        {
            JOptionPane.showMessageDialog( null, "Pf digita o grupo ", "AVISO", JOptionPane.WARNING_MESSAGE );
        }
    }
    ...
    {
        grupo.setDesignacao( this.descricao );
    }
    ...
    public void alterar()
    {
        ...
        if ( !vazios_campos() )
        {
            try
            {
                grupo = grupoDao.findGrupo( this.cod_funcao );
                this.descricao = MetodosUtil.iniciais_maiuscula( MetodosUtil.trimAll( txtDescricao.getText().trim() ) );
                preparar_objecto();
                grupoDao.edit( grupo );
                actualizar();
            ...
            {
                JOptionPane.showMessageDialog( null, "Erro ao alterar o grupo ", "ERRO", JOptionPane.ERROR_MESSAGE );
            }
        }
        else
        {
            JOptionPane.showMessageDialog( null, "Pf. seleccione o grupo para alterar" );
        }
