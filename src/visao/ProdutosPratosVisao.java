...
public class ProdutosPratosVisao extends javax.swing.JFrame
{
    ...
    public ProdutosPratosVisao( java.awt.Frame parent, boolean modal, int idUSer, BDConexao conexao )
    {
...
//        rbJanelaServico.setVisible( false );
        ...
        ProdutosPratosVisao.idUser = idUSer;
...
//        servico_produto();
    ...
    private void initComponents()
    {
        ...
        label_qtd_bruta1 = new javax.swing.JLabel();
        ...
        jPanel5.add(lbCusto, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 240, 200, 20));
        ...
        label_qtd_bruta1.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 16)); // NOI18N
        label_qtd_bruta1.setText("Unidade de Compra:");
        jPanel5.add(label_qtd_bruta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 140, -1));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("BUSCA DO PRATO"));
        ...
        txtPrecoVendaGrosso.setText("0.0");
        ...
        painel_stockLayout.setHorizontalGroup(
            ...
            .addGroup(painel_stockLayout.createSequentialGroup()
                ...
                .addGroup(painel_stockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(painel_stockLayout.createSequentialGroup()
                        .addComponent(lbPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtPercentagemGanhoRetalho, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jButtonCompras.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/calendario 32x32.png"))); // NOI18N
        jButtonCompras.setText("Ficha Técnica");
...
//        lbCusto.setText("Preço");
    ...
    private void mostrarPreco()
    {
        ...
        {
            lbCusto.setText( "Preço Venda do Prato:" );
//            lbCusto.setText( "Preço:" );
        }
    ...
    {//GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            new BuscaProdutoRefeicoesVisao( this, rootPaneCheckingEnabled, getCodigoArmazem( cmbarmazem2.getSelectedItem().toString() ), DVML.JANELA_PRODUTO, BDConexao.getInstancia()).setVisible(true);
            mostrar_qtd_stock_armazem(txtArmazen1, 1 );
            mostrar_qtd_stock_armazem( txtArmazen2, 2 );
            mostrar_qtd_stock_armazem( txtArmazen3, 3 );
            mostrar_qtd_stock_armazem( txtArmazen4, 4 );
...
//        txtCodigoBarra.setText( String.valueOf( produtosController.getLastProduto().getCodigo() + 1 ) );
    ...
    private void jButtonComprasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprasActionPerformed
        try
        {
            ...
            new FichaTecnicaVisao(idUser, BDConexao.getInstancia()).setVisible(true);
    ...
    public static void main( String args[] )
    {
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                try
                {
                    ProdutosPratosVisao dialog = new ProdutosPratosVisao( new javax.swing.JFrame(), true, 15, BDConexao.getInstancia() );
    ...
    public static void ver_dados_produtos( int codigo )
    {
        try
        {
            ...
            {
                procedimento_limpar();
                JOptionPane.showMessageDialog( null, "Não existe prato com este código", "Alerta", JOptionPane.WARNING_MESSAGE );
            }
        ...
        catch ( Exception e )
        {
            e.printStackTrace();
            procedimento_limpar();
            JOptionPane.showMessageDialog( null, e.getMessage(), "Falha na busca do prato\n"
                    + "ou prato desactivado.", JOptionPane.WARNING_MESSAGE );
        }
...
//        produto.setPercentagemDesconto( 0d );
    ...
    private boolean campos_validos_alterar()
    {
        ...
        {
            JOptionPane.showMessageDialog( null, "Já existe um prato com este codigo de barra." );
            txtCodigoBarra.requestFocus();
            return false;
        }
        else if ( produtosController.existProdutoByDesignacaoExcepto( produto.getCodigo(), getDesignacaoText() ) )
        {
            JOptionPane.showMessageDialog( null, "Já existe um prato na base de dados com esta designacao!" );
            txtDesignacao.requestFocus();
            return false;
        }
    ...
    private void set_dados_eliminar()
    {
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog( null, "Prato desactivado com sucesso!", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );
            procedimento_limpar_campos();
        }
        catch ( Exception e )
        {
...
//                    procedimento_limpar();
                ...
                catch ( Exception e )
                {
                    ...
                    conexaoTransaction.close();
                    JOptionPane.showMessageDialog( null, "Falha ao actualizar o prato", "Falha", JOptionPane.WARNING_MESSAGE );
                    return;
                }
                    ...
                    if ( !ivaAplicarJRadioButton.isSelected() )//APLICAR ISENÇÃO
                    {
                        ...
                        if ( Objects.nonNull( motivosIsensao ) )
                        {
                            ...
                            if ( !produtosIsentoControllerLocal.salvar( produtoIsento ) )
                            {
                                DocumentoDao.rollBackTransaction( conexaoTransaction );
                                conexaoTransaction.close();
                                JOptionPane.showMessageDialog( null, "Falha ao registrar o prato", "Falha", JOptionPane.WARNING_MESSAGE );
                                return;
    ...
    private void procedimento_alterar_servico_produto_eliminar()
    {
        ...
        {
            e.printStackTrace();
            JOptionPane.showMessageDialog( null, e.getMessage(), "Falha ao desactivar prato", JOptionPane.ERROR_MESSAGE );
        }
    ...
    private void set_combos()
    {
        ...
        cmbGrupo.setModel( new DefaultComboBoxModel( gruposController.getVectorRefeicoes() ) );
        try
        {
            cmbModelo.setModel( new DefaultComboBoxModel( modelosController.getVectorByIdMarca( getIdMarca() ) ) );
        }
...
//                txtQuantidadeStock.setText( String.valueOf( stockLocal.getQuantidadeExistente() ) );
    ...
    public static void ver_dados( int codigo )
    {
        ...
        {
            limpar_direito();
            JOptionPane.showMessageDialog( null, "O Prato ainda não existe. ", DVML.DVML_COMERCIAL, JOptionPane.INFORMATION_MESSAGE );

        }

    }

    private static void procedimento_limpar1()
    {
        limpar_1();
        limpar_direito();
        //actualizar
...
//        }
        ...
        {
            JOptionPane.showMessageDialog( null, "Pf. Selecione a unidade de medida do prato", DVML.DVML_COMERCIAL, JOptionPane.WARNING_MESSAGE );
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog( null, "Pf. Selecione a taxa do IVA do prato recomendado pela AGT", DVML.DVML_COMERCIAL, JOptionPane.WARNING_MESSAGE );
            return false;
        }
    ...
    private boolean camposValidosQtdGrossoPrecoGrosso()
    {
        ...
        {
            txtQtdGrosso.requestFocus();
            JOptionPane.showMessageDialog( null, "A quantidade grosso, não pode ser menor do que 2.", DVML.DVML_COMERCIAL, JOptionPane.WARNING_MESSAGE );
            return false;
...
//                txtCodigoBarra.setText( String.valueOf( codProduto ) );
            ...
            jLabelCodProduto.setText( "Cod. Prato: " + codProduto );
            txtCodigoBarra.setText( String.valueOf( codProduto ) );
        }
        catch ( Exception e )
        {
            jLabelCodProduto.setText( "Cod. Prato: " );
