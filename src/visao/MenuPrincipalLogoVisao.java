 ...
 *
 */
public class MenuPrincipalLogoVisao extends javax.swing.JFrame
{
    ...
    public MenuPrincipalLogoVisao( int cod, int id_empresa, boolean administrador, BDConexao conexao )
    {
...
//        jmAnulamentoEntradaProdutos.setVisible( false );
        ...
        this.setExtendedState( this.getExtendedState() | MenuPrincipalLogoVisao.MAXIMIZED_BOTH );
...
//        jmenuRelatorios.setEnabled( status );
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/fundo_cliente.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, -1, 990));
        ...
        jmenuRelatorios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/1323287592_stock_task.png"))); // NOI18N
        jmenuRelatorios.setText("Relatorio/Mapa");
        ...
        jmenuRelatorios.add(jmListarProdutosStock);
        ...
        jmenuRelatorios.add(jmRelatorioVendasPorUsuarioData);
        ...
        jmenuRelatorios.add(jmMapaExistencia);
        ...
        jmenuRelatorios.add(jmRelatorioAcertoStock);
        ...
        jmenuRelatorios.add(jmHistoricoBonusEmpresa);
...
//        new PosVisao("", cod_utilizador, this.conexao ).co( true );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MenuPrincipalLogoVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
