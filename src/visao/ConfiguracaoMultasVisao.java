...
//    }
    ...
    try {
        ...
        multa.setUsuario(usuarioLogado); // 🔹 Aqui o usuário não será null
...
//            {
//                JOptionPane.showMessageDialog( this, "Serviço não selecionado", "Atenção", JOptionPane.WARNING_MESSAGE );
//                txtCodigo.requestFocus();
//                return;
//            }
//
//            int codigoServico = Integer.parseInt( txtCodigo.getText().trim() );
//
//            TbProduto servico = produtosController.buscarPorCodigo( codigoServico );
//            if ( servico == null )
//            {
...
//
//            // 🔹 Dias
//            int dayStart = Integer.parseInt( txtDayStart.getText().trim() );
//            int dayEnd = Integer.parseInt( txtDayEnd.getText().trim() );
//
//            // 🔹 Valor
...
//            multaServicoController.create( multa );
//
//            JOptionPane.showMessageDialog( this, "Multa salva com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE );
//            limparCampos();
//
//        }
...
//        {
//            e.printStackTrace();
//            JOptionPane.showMessageDialog( this, "Erro ao salvar multa", "Erro", JOptionPane.ERROR_MESSAGE );
//        }
//    }
//    private void carregarDados()
//    {
//        List<Referencias> listarTodosByIdProduto = multaServicoController.listarTodosByIdProduto( codProduto );
