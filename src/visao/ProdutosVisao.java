...
public class ProdutosVisao extends javax.swing.JFrame
{
    ...
    public ProdutosVisao( java.awt.Frame parent, boolean modal, int idUSer, BDConexao conexao )
    {
...
//        helper.inicializar();
    ...
    private void initComponents()
    {
        ...
        jPanel5.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 510, 110, 40));
        ...
        jPanel5.add(btnAlterar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 510, 110, 40));
        ...
        jPanel5.add(btnLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 130, 40));
        ...
        jPanel5.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 530, 80));
        ...
        jPanel5.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 510, 150, 40));
        ...
        jPanel5.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 510, 120, 40));
        ...
        txtArmazen1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N

        txtArmazen2.setEditable(false);
        txtArmazen2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(cmbarmazem1, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtArmazen1, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbarmazem2, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtArmazen2, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbarmazem3, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtArmazen1, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//        lbCusto.setText("Preço");
    ...
    {//GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            new BuscaProdutoVisao( this, rootPaneCheckingEnabled, getCodigoArmazem( cmbarmazem2.getSelectedItem().toString() ), DVML.JANELA_PRODUTO, conexao ).setVisible( true );
            mostrar_qtd_stock_armazem( txtArmazen1, 1 );
            mostrar_qtd_stock_armazem( txtArmazen2, 2 );
            mostrar_qtd_stock_armazem( txtArmazen3, 3 );
            mostrar_qtd_stock_armazem( txtArmazen4, 4 );
...
//        txtCodigoBarra.setText( String.valueOf( produtosController.getLastProduto().getCodigo() + 1 ) );
    ...
    {//GEN-HEADEREND:event_jButton5ActionPerformed
        ...
        try
        {
            ...
            new BuscaProdutoVisao( this, rootPaneCheckingEnabled, getCodigoArmazem( cmbarmazem1.getSelectedItem().toString() ), DVML.JANELA_PRODUTO, conexao ).setVisible( true );
            mostrar_qtd_stock_armazem( txtArmazen1, 1 );
            mostrar_qtd_stock_armazem( txtArmazen2, 2 );
            mostrar_qtd_stock_armazem( txtArmazen3, 3 );
            mostrar_qtd_stock_armazem( txtArmazen4, 4 );
...
//                    else 
    ...
    private void set_combos()
    {
        ...
        cmbGrupo.setModel( new DefaultComboBoxModel( gruposController.getVector() ) );
        try
        {
            cmbModelo.setModel( new DefaultComboBoxModel( modelosController.getVectorByIdMarca( getIdMarca() ) ) );
        }
