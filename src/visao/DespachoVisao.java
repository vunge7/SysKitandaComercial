 ...
 */
public class DespachoVisao extends javax.swing.JFrame
{
    ...
    public DespachoVisao( int idUser, BDConexao conexao )
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("DESPACHO DE VIATURA:  DES 2024/001");
        ...
        jPanel12.add(txtRef, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 240, 38));
        ...
        jPanel12.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 70, 41));
        ...
        jPanel12.add(cmbAnoEconomico, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 100, 40));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Resolução", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N

        txtResolucao.setColumns(20);
        txtResolucao.setRows(5);
        jScrollPane1.setViewportView(txtResolucao);
        ...
        jPanel13.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Funcionários Técnicos envolvidos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N

        txtFuncionarios.setColumns(20);
        txtFuncionarios.setRows(5);
        jScrollPane2.setViewportView(txtFuncionarios);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(150, 150, 150)
                .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, 837, Short.MAX_VALUE))
...
//        actualizar_abreviacao();
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(DespachoVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new DespachoVisao( 15, BDConexao.getInstancia() ).setVisible( true );
            }
        } );
    }
    ...
    private void procRegistrar()
    {
        ...
        if ( last_venda > 0 )
        {
            ...
            {
                JOptionPane.showMessageDialog( null, "Despacho feito com sucesso!" );
    ...
    private void prepararDetalhe( int lastVenda )
    {
        ...
        detalhesDocumento.setNotas(txtResolucao.getText() );
...
//        mostrar_proximo_codigo_documento();
        ...
        venda_local.setDataVenda( venda_original.getDataVenda() );
        ...
        venda_local.setReferencia(txtResolucao.getText() );
...
//        venda_local.setHashCod( MetodosUtil.criptografia_hash( prox_doc ) );
        ...
        venda_local.setNDocMotorista(txtFuncionarios.getText());
        venda_local.setObs( "" );
...
//        venda_local.setRefDataFact( CfMethods.fullDateToText( venda_local.getDataVenda() ) );
    ...
    private void mostrar_proximo_codigo_documento()
    {
        try
        {
            ...
            jLabel1.setText( "DESPACHO N:" + prox_doc );
        }
        catch ( Exception e )
        {
            documento = null;
