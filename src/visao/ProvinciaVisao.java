...
//    private TipoPagamentoDiversoDao  tipoPagamentoDao = new TipoPagamentoDiversoDao(emf);
    ...
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !provinciaDao.exist_provincia(txtDescricao.getText() ) )
                {
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar a provincia ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta a provincia ja existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digita a provincia ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    public void setDadosProvincia(){
                provincia.setDescrisao( txtDescricao.getText().toUpperCase() );
                provincia.setIdPais(   paisDao.findTbPais( getIdPais() )  );
    }
...
//            txtDescricao.setText(   tipoPagamento.getDescrisao() );
    ...
    public void alterar()
    {
       ...
       {
                try {
                            provincia = provinciaDao.findTbProvincia(  this.cod_provincia );
                            setDadosProvincia();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar a provincia ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. seleccione a provincia para alterar");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nova Província");
    ...
    private void cmbPaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbPaisActionPerformed
        // TODO add your handling code here:
        cmbProvincia.setModel(   new DefaultComboBoxModel( (Vector) provinciaDao.getDescricaoByIdPais( getIdPais() )   )  );  
        txtDescricao.setText(  String.valueOf(  cmbProvincia.getSelectedItem()   ));
        this.cod_provincia =  provinciaDao.getIdByDescricao(  txtDescricao.getText() ) ;
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProvinciaVisao().setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<TbProvincia> provincia)
    {
            ...
            for (int i = 0; i < provincia.size(); i++) 
            {
               ...
               provincia.get(i).getIdProvincia(),
               provincia.get(i).getDescrisao(),
               provincia.get(i).getIdPais().getDescrisao()
    ...
    public void setDadosProvinciaModelo()
    {
            ...
            this.cod_provincia =   Integer.parseInt( String.valueOf( modelo.getValueAt(jTable1.getSelectedRow(), 0) ) );
