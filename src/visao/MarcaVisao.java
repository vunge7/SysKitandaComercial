 ...
 */
public class MarcaVisao extends javax.swing.JFrame
{

    private EntityManagerFactory emf = JPAEntityMannagerFactoryUtil.em;
    private Marca marca;
    private MarcaDao marcaDao = new MarcaDao( emf );
    private int cod_marca = 0;
    ...
    private void adicionar_tabela( List<Marca> marca )
    {
        ...
        for ( int i = 0; i < marca.size(); i++ )
        {
            ...
            {
                marca.get( i ).getPkMarca(),
                marca.get( i ).getDesignacao()
    ...
    public void setDadosFuncaoModelo()
    {
        ...
        this.cod_marca = Integer.parseInt( String.valueOf( modelo.getValueAt( jTable1.getSelectedRow(), 0 ) ) );

    }

    private void actualizar()
    {
        adicionar_tabela( marcaDao.buscaAllEntity() );
    }
    ...
    public void salvar()
    {
        ...
        if ( !vazios_campos() )
        {
            ...
            if ( !marcaDao.exist_marca( this.descricao ) )
            {
                try
                {
                    marca = new Marca();
            ...
            {
                JOptionPane.showMessageDialog( null, "Esta marca ja existe", "AVISO", JOptionPane.WARNING_MESSAGE );
            }
        }
        else
        {
            JOptionPane.showMessageDialog( null, "Pf digita a marca ", "AVISO", JOptionPane.WARNING_MESSAGE );
        }
    }
    ...
    {
        marca.setDesignacao( txtDescricao.getText().toUpperCase() );
    }
    ...
    public void alterar()
    {
        ...
        if ( !vazios_campos() )
        {
            try
            {
                marca = marcaDao.findMarca( this.cod_marca );
                this.descricao = MetodosUtil.iniciais_maiuscula( MetodosUtil.trimAll( txtDescricao.getText().trim() ) );
                preparar_objecto();
                marcaDao.edit( marca );
                actualizar();
            ...
            {
                JOptionPane.showMessageDialog( null, "Erro ao alterar a marca ", "ERRO", JOptionPane.ERROR_MESSAGE );
            }
        }
        else
        {
            JOptionPane.showMessageDialog( null, "Pf. seleccione a marca para alterar" );
        }
