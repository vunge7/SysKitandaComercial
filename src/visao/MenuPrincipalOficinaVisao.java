 ...
 *
 */
public class MenuPrincipalOficinaVisao extends javax.swing.JFrame
{
    ...
    public MenuPrincipalOficinaVisao( int cod, int id_empresa, boolean administrador, BDConexao conexao )
    {
...
//        jmAnulamentoEntradaProdutos.setVisible( false );
        ...
        this.setExtendedState( this.getExtendedState() | MenuPrincipalOficinaVisao.MAXIMIZED_BOTH );
...
//        jmGestaoMesas.setEnabled( status );
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fundo_layout_01.png"))); // NOI18N
        ...
        jMenuItem4.setText("Gerar SAFT de Inventário");
    ...
    private void jmVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmVendaActionPerformed
        ...
        {
            // TODO add your handling code here
            new VendaOficinaUsuarioVisao(cod_utilizador, BDConexao.getInstancia()).setVisible(true);
//            new VendaOficinaUsuarioVisao(cod_utilizador, BDConexao.getInstancia()).setVisible(true);
        ...
        {
            Logger.getLogger( MenuPrincipalOficinaVisao.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//        new PosVisao("", cod_utilizador, this.conexao ).co( true );
    ...
    {//GEN-HEADEREND:event_jMenuItem2ActionPerformed
        try
        {
            new DespachoVisao( cod_utilizador, this.conexao ).setVisible( true );
        }
        catch ( Exception e )
        {
        }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MenuPrincipalOficinaVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
