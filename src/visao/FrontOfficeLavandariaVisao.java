 ...
 */
public class FrontOfficeLavandariaVisao extends javax.swing.JFrame
{
    ...
    public FrontOfficeLavandariaVisao( int id_usuario, BDConexao conexao )
    {
        initComponents();
        ...
        painel_armazem.setVisible( false );
    ...
    {//GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        new LoginVisao( id_usuario ).setVisible( true );
//        retorno();
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( FrontOfficeLavandariaVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
