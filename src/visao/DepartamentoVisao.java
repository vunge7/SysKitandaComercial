    ...
    */
    ...
    public void salvar(){
        ...
        if(!vazios_campos() )
        {
                ...
                }else  JOptionPane.showMessageDialog(null, "Este departamento ja existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digita o departamento ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    public void alterar(){
       ...
       }else JOptionPane.showMessageDialog(null, "Pf. seleccione a departamento para alterar");
