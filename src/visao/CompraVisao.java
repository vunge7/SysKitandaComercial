 ...
 */
public class CompraVisao extends javax.swing.JFrame implements Runnable
{
    ...
    public CompraVisao( int cod_usuario, BDConexao conexao )
    {
...
//                                cmbArmazem.setModel(new DefaultComboBoxModel(armazemDao.buscaTodos1()));
    ...
    private void initComponents()
    {
        ...
        jPanel3.add(txtQtdEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 140, 70, 40));
...
//        actualizar_abreviacao();
    ...
    {
        new CompraVisao( 15, new BDConexao() ).show();
    }
