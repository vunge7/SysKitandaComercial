 ...
 */
public class VendaOficinaVisao extends javax.swing.JFrame
{
    ...
    public VendaOficinaVisao( int cod_usuario, BDConexao conexao ) throws SQLException
    {
        ...
        //pegarResolucao();
        VendaOficinaVisao.conexao = conexao;

        /**
         * INSTANCIAS DOS CONTROLLER COMERCIAL
         */
        vendasController = new VendasController( VendaOficinaVisao.conexao );
        itemVendasController = new ItemVendasController( VendaOficinaVisao.conexao );
        mesasController = new MesasController( VendaOficinaVisao.conexao );
        lugaresController = new LugaresController( VendaOficinaVisao.conexao );
        produtosController = new ProdutosController( VendaOficinaVisao.conexao );
        stocksController = new StoksController( VendaOficinaVisao.conexao );
        precosController = new PrecosController( VendaOficinaVisao.conexao );
        tipoProdutoController = new TipoProdutosController( VendaOficinaVisao.conexao );
        familiaController = new FamiliasController( VendaOficinaVisao.conexao );
        armazensController = new ArmazensController( VendaOficinaVisao.conexao );
        localController = new LocalController( VendaOficinaVisao.conexao );
        unidadesController = new UnidadesController( VendaOficinaVisao.conexao );
        anoEconomicoController = new AnoEconomicoController( VendaOficinaVisao.conexao );
        clientesController = new ClientesController( VendaOficinaVisao.conexao );
        documentosController = new DocumentosController( VendaOficinaVisao.conexao );
        moedasController = new MoedasController( VendaOficinaVisao.conexao );
        descontosController = new DescontosController( VendaOficinaVisao.conexao );
        usuariosController = new UsuariosController( VendaOficinaVisao.conexao );
        dadosInstituicaoController = new DadosInstituicaoController( VendaOficinaVisao.conexao );
        produtosImpostoController = new ProdutosImpostoController( VendaOficinaVisao.conexao );
        produtosIsentoController = new ProdutosIsentoController( VendaOficinaVisao.conexao );
        caixasController = new CaixasController( VendaOficinaVisao.conexao );
        formaPagamentoController = new FormaPagamentoController( VendaOficinaVisao.conexao );
        armazensAccessoController = new ArmazensAccessoController( VendaOficinaVisao.conexao );
        cambiosController = new CambiosController( VendaOficinaVisao.conexao );
        formaPagamentoItemController = new FormaPagamentoItemController( VendaOficinaVisao.conexao );
        servicosRetencaoController = new ServicosRetencaoController( VendaOficinaVisao.conexao );
        contaController = new ContaController( VendaOficinaVisao.conexao );
...
//        habilitarColunas();
    ...
    private void initComponents()
    {
        ...
        jPanel4.add(txtQuantidadeStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 80, 60));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                ...
                .addGroup(jPanelCaracteristicasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelCaracteristicasLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtKilometragem, javax.swing.GroupLayout.PREFERRED_SIZE, 7, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(txtMotorista, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanelCaracteristicasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanelCaracteristicas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addGap(12, 12, 12)
                                    .addComponent(dc_data_vencimento, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
//        }
    ...
    private void accao_codigo_manual_enter()
    {
        ...
        {
            ex.printStackTrace();
            Logger.getLogger( VendaOficinaVisao.class.getName() ).log( Level.SEVERE, null, ex );
...
//        {
        if ( !exist_produto_tabela_formulario( codigo_produto ) )
        {
            ...
            if ( !validar_zero() )
            {
                ...
                String precoUnitario = CfMethods.formatarComoMoedaPreco( getPreco() );
...
//        {
        if ( true )
        {
            ...
            if ( !validar_zero() )
            {
                ...
                System.out.println( "RET: " + ret );
                System.out.println( "TAX: " + taxa );
                String precoUnitario = CfMethods.formatarComoMoedaPreco( 0 );
//              ( double qtd, double taxa, double preco_venda, double desconto )
                String total_linha_retencao = CfMethods.formatarComoMoeda( getValorComRetencao(
                        qtd,
                        ret,
...
//    }
    ...
    private static void salvar_venda_comercial()
    {
        ...
        Date data_vencimento = dc_data_vencimento.getDate();
        TbVenda venda_local = new TbVenda();
        venda_local.setDataVenda( data_documento );
        venda_local.setDataVencimento( data_vencimento );
...
//        venda_local.setHashCod( MetodosUtil.criptografia_hash( prox_doc ) );
        ...
        venda_local.setModelo( txtMotorista.getText() );
        venda_local.setNumMotor( txtMatricula.getText() );

        venda_local.setNomeMotorista( txtMotorista.getText() );
        ...
        venda_local.setNumChassi( txtNumeroCarta.getText() );
        venda_local.setObs( txtObs.getText() );
        venda_local.setCorCarro( "" );
        venda_local.setNDocMotorista( txtNumeroCarta.getText() );
...
//    }
    ...
    {
        new VendaOficinaVisao( 15, BDConexao.getInstancia() ).show( true );
    }
...
//            }
    ...
    private void actualizarPreco()
    {
        ...
        if ( idProduto == 0 )
        {
            ...
            preparar_produto( designacao, CfMethods.parseMoedaFormatada( precoLocal ) );
            produtosController.salvar( produto );
            idProduto = produtosController.getLastProduto().getCodigo();
            produto = produtosController.findByCod( idProduto );
            table.setValueAt( idProduto, table.getSelectedRow(), 0 );
            registrar_preco( precosController, CfMethods.parseMoedaFormatada( precoLocal ) );
        }
        ...
        String precoUnitario = CfMethods.formatarComoMoeda( Double.parseDouble( precoLocal ) );
...
//        produto.setPercentagemDesconto( 0d );
    ...
    private boolean registrar_preco( PrecosController precosControllerLocal, double precoVendaParm )
    {


        /*PRIMEIRO PRECO RETALHO*/
        setDadosPreco( precoVendaParm );
        preco.setQtdBaixo( 0 );
        preco.setQtdAlto( (int) DVML.QTD_DEFAULT );
...
//        preco.setQtdBaixo( (int) DVML.QTD_DEFAULT );
            preco.setQtdBaixo( (int) ( DVML.QTD_DEFAULT + 1 ) );
...
//
    ...
    private void setDadosPreco( double precoCompra )
    {
        preco = new TbPreco();
