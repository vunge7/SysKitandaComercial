...
public class ProdutosIngredienteVisao extends javax.swing.JFrame
{
    ...
    public ProdutosIngredienteVisao( java.awt.Frame parent, boolean modal, int idUSer, BDConexao conexao )
    {
        ...
        ProdutosIngredienteVisao.idUser = idUSer;
...
//        servico_produto();
    ...
    private void cmbTipoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbTipoProdutoActionPerformed
        ...
        {
            Logger.getLogger( ProdutosIngredienteVisao.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//        txtCodigoBarra.setText( String.valueOf( produtosController.getLastProduto().getCodigo() + 1 ) );
    ...
    {//GEN-HEADEREND:event_txtPrecoVendaRetalhoActionPerformed
        // TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_txtPercentagemGanhoRetalhoActionPerformed
        // TODO add your handling code here:
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( ProdutosIngredienteVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
    ...
    private com.toedter.calendar.JDateChooser jcDataExpiracao;
    private com.toedter.calendar.JDateChooser jcDataFabrico;
    ...
    private javax.swing.JPanel painel_stock;
    ...
    private javax.swing.JTextField txtPercentagemGanhoRetalho;
    ...
    private javax.swing.JTextField txtPrecoVendaGrosso;
    private javax.swing.JTextField txtPrecoVendaRetalho;
    private javax.swing.JTextField txtQtdGrosso;
