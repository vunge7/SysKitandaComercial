...
import util.FormExtratoContaCliente;
...
//        btn_feicho_dia_root.setVisible( false);
    ...
    private void initComponents() {
        ...
        btnGerarExtratoAutomatico = new javax.swing.JButton();
        ...
        btnGerarExtratoAutomatico.setText("Gerar Extrato Automático");
        btnGerarExtratoAutomatico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGerarExtratoAutomaticoActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(fundo_principalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(fundo_principalLayout.createSequentialGroup()
                                ...
                                .addGroup(fundo_principalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(btnGerarExtratoAutomatico, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        fundo_principalLayout.setVerticalGroup(
            ...
            .addGroup(fundo_principalLayout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(btnGerarExtratoAutomatico, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        dispose();
//        new MenuPrincipalTesourariaVisao(this.idUser).setVisible(true);
...
//        new CaixaVisao( this.idUser, BDConexao.getInstancia()).setVisible(true);
...
//        new MenuPrincipalTesourariaVisao( this.idUser, this.idEmpresa, BDConexao.getInstancia()).setVisible(true);
    ...
    private void btnGerarExtratoAutomaticoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarExtratoAutomaticoActionPerformed
        // TODO add your handling code here:
        new FormExtratoContaCliente(conexao).setVisible(true);
    }//GEN-LAST:event_btnGerarExtratoAutomaticoActionPerformed
    ...
    private javax.swing.JButton btnGerarExtratoAutomatico;
...
//                    }
    ...
    private void activar_opcoes() {
        ...
        if (idUser == 15) {
            ...
            btnGerarExtratoAutomatico.setVisible(true);
            ...
            btnGerarExtratoAutomatico.setVisible(false);
