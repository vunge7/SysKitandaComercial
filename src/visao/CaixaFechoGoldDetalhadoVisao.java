...
import lista.ReconciliacaoCaixaDetalhadoReport;
 ...
 */
public class CaixaFechoGoldDetalhadoVisao extends javax.swing.JFrame
{
    ...
    public CaixaFechoGoldDetalhadoVisao( int idUser, BDConexao conexao, boolean touch )
    {
        initComponents();
        ...
        this.idUser = idUser;
        this.touch = touch;
        dadosInstituicaoController = new DadosInstituicaoController( CaixaFechoGoldDetalhadoVisao.conexao );
        caixa_controller = new CaixasController( CaixaFechoGoldDetalhadoVisao.conexao );
        item_caixa_controller = new ItemCaixaController( CaixaFechoGoldDetalhadoVisao.conexao );
        formaPagamentoItemController = new FormaPagamentoItemController( CaixaFechoGoldDetalhadoVisao.conexao );
        formaPagamentoController = new FormaPagamentoController( CaixaFechoGoldDetalhadoVisao.conexao );
        usuariosController = new UsuariosController( CaixaFechoGoldDetalhadoVisao.conexao );
        vendasController = new VendasController( CaixaFechoGoldDetalhadoVisao.conexao );
        setNumeroCaixa();
        config();
        carregar_dados();
    }
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(CaixaFechoGoldDetalhadoVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new CaixaFechoGoldDetalhadoVisao( 15, BDConexao.getInstancia(), false ).setVisible( true );
            }
        } );
    }
...
//                            BigDecimal valor_declarado = new BigDecimal(modelo.getValueAt(i, 1).toString());
                ...
                if ( sucesso )
                {
                    ...
                    try
                    {
                        ReconciliacaoCaixaDetalhadoReport rb = new ReconciliacaoCaixaDetalhadoReport( caixa_actual.getPkCaixa(), conexaoTransaction );
                        NLExporToPdfForSandEmailReport exporToPdf = new NLExporToPdfForSandEmailReport( conexaoTransaction );
