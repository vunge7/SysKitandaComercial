 ...
 */
public class GuiaTransportesVisao extends javax.swing.JFrame implements Runnable
{
    ...
    public GuiaTransportesVisao( int cod_usuario, BDConexao conexao )
    {
    ...
    private void initComponents()
    {
        ...
        setTitle("...:::::  KITANDA - GUIA DE TRANSPORTE  ::::...");
        ...
        lb_proximo_documento.setText("PRÓXIMO DOC. : XX GT/A1");
    ...
    private void txtLocalDestinoActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_txtLocalDestinoActionPerformed
    {//GEN-HEADEREND:event_txtLocalDestinoActionPerformed
        // TODO add your handling code here:
    ...
    private javax.swing.JLabel lbCliente9;
...
//            TbVenda venda = vendaDao.findByCodFact(ref_doc, DVML.DOC_FACTURA_PROFORMA_PP);
            TbVenda venda = vendaDao.findByCodFact( ref_doc );
    ...
    public int getIdDocumento()
    {
        try
        {
            return DVML.DOC_GUIA_TRANSPORTE_GT;
        }
        catch ( Exception e )
        {
            return 0;
...
//        nota_levantamento.setHashCod( MetodosUtil.criptografia_hash( venda_local, getGrossTotal(), conexao ) );
        ...
        try
        {
            ...
            //criar_itens
            salvarItemVenda( last_venda, venda.getTbItemVendaList() );
            actualizar_cod_doc();
            // txtClienteNome.requestFocus();
            actualizar_abreviacao();
    ...
    public double getPrecoProduto( int codProduto, boolean stocavel )
    {
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog( null, "O produto provavelmente não é stocavel!..." );
        }
        ResultSet rs = conexao.executeQuery( sql );
...
//        refresh_table();
    ...
    private void salvarItemVenda( int cod_venda, List<TbItemVenda> tbItemVendaList )
    {
        for ( TbItemVenda tbItemVenda : tbItemVendaList )
        {
            ...
            itemVendaDao.criarComProcedimentos( linha_local, conexao );
    ...
    private void mudar_status_campos()
    {
        txtNomeMotorista.setEnabled( true);
        txtDocBICE.setEnabled( true);
        txtMarcaCarro.setEnabled( true);
        txtMatricula.setEnabled( true);
        txtCor.setEnabled( true);
        txtLocalDestino.setEnabled( true);
