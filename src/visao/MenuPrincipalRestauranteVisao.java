 ...
 *
 */
public class MenuPrincipalRestauranteVisao extends javax.swing.JFrame
{
    ...
    public MenuPrincipalRestauranteVisao( int cod, int id_empresa, boolean administrador, BDConexao conexao )
    {
...
//        JMenuPedidosCancelados.setVisible( false);
        jmFamilia.setVisible( false );
        jMenuItemGestaoCreditos.setVisible( false );
        jMenuItemConverterGuia.setVisible( false );
        jMenuItemAlteracaoGuia.setVisible( false );
        jMenuItemGuiaTransportes.setVisible( false );
...
//        jmAnulamentoEntradaProdutos.setVisible( false );
        ...
        this.setExtendedState( this.getExtendedState() | MenuPrincipalRestauranteVisao.MAXIMIZED_BOTH );
...
//            }
            ...
            else if ( permissao.equals( jMenuItemConsultas.getText() ) )
            {
                jMenuItemConsultas.setEnabled( true );
            }
            else if ( permissao.equals( JMenuPedidosCancelados.getText() ) )
            {
                JMenuPedidosCancelados.setEnabled( true );
            }
...
//        jmGestaoMesas.setEnabled( status );
        ...
        jMenuItemConsultas.setEnabled( status );
        jMenuItemRelatorioMensal.setEnabled( status );
        JMenuPedidosCancelados.setEnabled( status );
    ...
    private void initComponents()
    {
        ...
        jMenuItemGuiaTransportes = new javax.swing.JMenuItem();
        ...
        JMenuPedidosCancelados = new javax.swing.JMenuItem();
        ...
        jmVasilhame = new javax.swing.JMenu();
        jm_cadastro_vasilhame = new javax.swing.JMenuItem();
        jm_entrada_vasilhame = new javax.swing.JMenuItem();
        jm_saida_vasilhame = new javax.swing.JMenuItem();
        ...
        jmSolicitacaoCompras1 = new javax.swing.JMenuItem();
        jmAutorizacaoCompras1 = new javax.swing.JMenuItem();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem_layout/layout_restaurante1.jpg"))); // NOI18N
        ...
        jMenuItemGuiaTransportes.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G, java.awt.event.InputEvent.SHIFT_DOWN_MASK));
        jMenuItemGuiaTransportes.setText("Guia Transporte");
        jMenuItemGuiaTransportes.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jMenuItemGuiaTransportesActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItemGuiaTransportes);
        ...
        JMenuPedidosCancelados.setText("Pedidos Cancelados");
        JMenuPedidosCancelados.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                JMenuPedidosCanceladosActionPerformed(evt);
            }
        });
        jMenu1.add(JMenuPedidosCancelados);
        ...
        jMenu2.add(jmListarProdutosStock);

        jMenu8.setText("Relatórios de Vendas");
        ...
        jMenu8.add(jmRelatorioVendasPorUsuarioData);
        ...
        jMenu8.add(jmRelatorioVendasPorClienteData);
        ...
        jMenu8.add(jMenuItemRelatorioQtdDetalhado);
        ...
        jMenu8.add(jmRelatorioFormaPagamento);
        ...
        jMenu8.add(jmVendaDetalhadasClientes);
        ...
        jMenu8.add(jmVendaDetalhadasUsuarios);
        ...
        jMenu8.add(jmRelatorioDiarioTodasVendasTempoReal);

        jMenu2.add(jMenu8);

        jMenu9.setText("Relatórios de Compras");
        ...
        jMenu9.add(jmRelatorioQTDComprados);
        ...
        jMenu9.add(jmRelatorioComprasPorFornecedor);
        ...
        jMenu10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens32x32/System32x32.png"))); // NOI18N
        jMenu10.setText("Economato");

        jmSolicitacaoCompras1.setText("Ficha Técnica");
        jmSolicitacaoCompras1.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jmSolicitacaoCompras1ActionPerformed(evt);
            }
        });
        jMenu10.add(jmSolicitacaoCompras1);

        jmAutorizacaoCompras1.setText("Entradas de Pratos");
        jmAutorizacaoCompras1.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jmAutorizacaoCompras1ActionPerformed(evt);
            }
        });
        jMenu10.add(jmAutorizacaoCompras1);

        jMenuItem5.setText("Criar Pratos");
        ...
        jMenuItem10.setText("Criar Ingredientes");
...
//        new ReciboVisao( cod_utilizador, this.conexao ).setVisible( true );
    ...
    private void jmListagemVasilhamesActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jmListagemVasilhamesActionPerformed
    ...
    private void jm_saida_vasilhameActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jm_saida_vasilhameActionPerformed
    ...
    private void jm_entrada_vasilhameActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jm_entrada_vasilhameActionPerformed
    ...
    {//GEN-HEADEREND:event_jmReeprmirFacuraActionPerformed
        ...
        new ReemprimirFacturasVisao( this, rootPaneCheckingEnabled, BDConexao.getInstancia()).setVisible(true);
...
//        relatorioAcertoStockVisualizar();
    ...
    {//GEN-HEADEREND:event_jmFrontOfficeActionPerformed
        // TODO add your handling code here:
        new FrontOfficeRestauranteVisao( cod_utilizador, BDConexao.getInstancia()).setVisible(true);
//        new PosVisao("", cod_utilizador, this.conexao ).co( true );
    ...
    private void jMenuItemGuiaTransportesActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jMenuItemGuiaTransportesActionPerformed
    {//GEN-HEADEREND:event_jMenuItemGuiaTransportesActionPerformed
        new GuiaTransportesVisao( cod_utilizador, this.conexao ).setVisible( true );
    }//GEN-LAST:event_jMenuItemGuiaTransportesActionPerformed
    ...
    private void JMenuPedidosCanceladosActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_JMenuPedidosCanceladosActionPerformed
    {//GEN-HEADEREND:event_JMenuPedidosCanceladosActionPerformed
        try
        {
            new ListarProdutosCancelados( this.conexao, cod_utilizador ).setVisible(true);
        }
        catch ( Exception e )
        {
            e.printStackTrace();
        }
    }//GEN-LAST:event_JMenuPedidosCanceladosActionPerformed
    ...
    private void jmSolicitacaoCompras1ActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jmSolicitacaoCompras1ActionPerformed
    {//GEN-HEADEREND:event_jmSolicitacaoCompras1ActionPerformed
        try
        {

            new FichaTecnicaVisao(cod_utilizador, BDConexao.getInstancia()).setVisible(true);
    ...
    }//GEN-LAST:event_jmSolicitacaoCompras1ActionPerformed

    private void jmAutorizacaoCompras1ActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jmAutorizacaoCompras1ActionPerformed
    {//GEN-HEADEREND:event_jmAutorizacaoCompras1ActionPerformed
        try
        {
            new EntradaPratosCompostosVisao( cod_utilizador, this.conexao ).setVisible( true );
        }
        catch ( SQLException ex )
        {
            Logger.getLogger( MenuPrincipalVisao.class.getName() ).log( Level.SEVERE, null, ex );
        }
    }//GEN-LAST:event_jmAutorizacaoCompras1ActionPerformed
    ...
    {//GEN-HEADEREND:event_jMenuItem5ActionPerformed
        try
        {
            ...
            new ProdutosPratosVisao( this, rootPaneCheckingEnabled, cod_utilizador, this.conexao ).setVisible( true );
        }
        catch ( Exception ex )
        {
            Logger.getLogger( MenuPrincipalRestauranteVisao.class.getName() ).log( Level.SEVERE, null, ex );
    ...
    {//GEN-HEADEREND:event_jMenuItem10ActionPerformed
        try
        {
            ...
            new ProdutosIngredientesVisao( this, rootPaneCheckingEnabled, cod_utilizador, this.conexao ).setVisible( true );
        }
        catch ( Exception ex )
        {
            Logger.getLogger( MenuPrincipalRestauranteVisao.class.getName() ).log( Level.SEVERE, null, ex );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MenuPrincipalRestauranteVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
    ...
    private javax.swing.JMenuItem JMenuPedidosCancelados;
    ...
    private javax.swing.JMenuItem jMenuItemGuiaTransportes;
    ...
    private javax.swing.JMenuItem jmAutorizacaoCompras1;
    ...
    private javax.swing.JMenuItem jmGerarSaftCompras;
    private javax.swing.JMenuItem jmGerarSaftVendas;
    ...
    private javax.swing.JMenuItem jmListagemVasilhames;
    ...
    private javax.swing.JMenuItem jmSolicitacaoCompras1;
    ...
    private javax.swing.JMenu jmVasilhame;
    ...
    private javax.swing.JMenuItem jm_cadastro_vasilhame;
    private javax.swing.JMenuItem jm_entrada_vasilhame;
