 ...
 */
public class TecladoNumeroLugarVisao extends javax.swing.JDialog
{
    ...
    public TecladoNumeroLugarVisao( java.awt.Frame parent, boolean modal, JTable tabela, int linha, int coluna, int formulario )
    {
        super( parent, modal );
        initComponents();
...
//        setLocation( ( int ) parent.getX() + ( parent.getWidth() / 3 ), parent.getHeight() / 2 );
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger(TecladoNumeroLugarVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new TecladoNumeroLugarVisao( new JFrame(), true, null, 0, 0, 0 ).setVisible( true );
            }
        } );
    }
    ...
    private void enviar_forma_pagamento()
    {
        ...
        if ( !txtVisor.getText().equals( "" ) )
        {
            if ( coluna == 2 )
            {
                ...
                tabela_forma_pagamento.setValueAt( referencia, linha, coluna );
                dispose();
            }
            if ( coluna == 3 )
            {
